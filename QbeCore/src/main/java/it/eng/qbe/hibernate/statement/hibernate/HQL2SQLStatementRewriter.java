...
package it.eng.qbe.hibernate.statement.hibernate;
...
public class HQL2SQLStatementRewriter {
	...
	public String rewrite(String query) {
		...
		try {
			...
			try {
				queryTranslator = (QueryTranslator) createQueryTranslatorMethod.invoke(astQueryTranslatorFactory, new Object[] { hibQuery.getQueryString(),
						Collections.EMPTY_MAP, sessionFactoryImplementor });
			} catch (Throwable e) {
				e.printStackTrace();
			}
