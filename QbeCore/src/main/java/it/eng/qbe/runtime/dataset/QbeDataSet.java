...
package it.eng.qbe.runtime.dataset;
...
public class QbeDataSet extends ConfigurableDataSet {
	...
	private void init() {
		if (ds == null) {
			it.eng.qbe.runtime.datasource.IDataSource qbeDataSource = getQbeDataSource();
	...
	public it.eng.qbe.runtime.datasource.IDataSource getQbeDataSource() {
	...
	public it.eng.qbe.runtime.datasource.IDataSource getDataSourceFromDataSet(Map<String, Object> dataSourceProperties, boolean useCache) {

		it.eng.qbe.runtime.datasource.IDataSource dataSource;
	...
	private it.eng.qbe.runtime.datasource.IDataSource getORMDataSource(List<String> dataMartNames, Map<String, Object> dataSourceProperties, boolean useCache) {
	...
	public QueryCatalogue getCatalogue(String json, it.eng.qbe.runtime.datasource.IDataSource dataSource) {
		...
		try {
			...
			for (int i = 0; i < queriesJSON.length(); i++) {
				...
				query = it.eng.qbe.serialization.query.serializer.SerializerFactory.getDeserializer("application/json").deserializeQuery(queryJSON, dataSource);
