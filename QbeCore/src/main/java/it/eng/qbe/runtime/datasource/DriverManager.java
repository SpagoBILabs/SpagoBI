...
import it.eng.qbe.hibernate.datasource.hibernate.HibernateDriverWithClassLoader;
import it.eng.qbe.jpa.datasource.jpa.JPADriver;
import it.eng.qbe.jpa.datasource.jpa.JPADriverWithClassLoader;
...
public class DriverManager {
	...
	/**
	 * Get the datasource for the passed driver and with the passed configuration.. If the datasource live in the cache it will not be rebuild
	 * 
	 * @param driverName
	 *            name of the driver jpa/hibernate
	 * @param configuration
	 ...
	 *            configuration of the datasource
	 * @param cache
	 *            if true the datasources cache will be enabled
	 * @return
	 */
