...
/**
 * This class allow to manage the configuration in memory. Nothing is loaded. It is the caller to injects values at runtime into the configuration.
 *
...
public class InMemoryDataSourceConfiguration extends AbstractDataSourceConfiguration {
	...
	public IModelProperties loadModelProperties() {
		if (modelProperties == null)
			modelProperties = super.loadModelProperties();
		return modelProperties;
	}

	@Override
	public IModelProperties loadModelI18NProperties() {
		if (modelI18NProperties == null)
			modelI18NProperties = super.loadModelI18NProperties();
	...
	public Map<String, Object> loadDataSourceProperties() {
		if (dataSourceProperties == null)
			dataSourceProperties = super.loadDataSourceProperties();
	...
	public List<IModelRelationshipDescriptor> loadRelationships() {
		if (realtionships == null)
			realtionships = super.loadRelationships();
	...
	public Map<String, List<ModelCalculatedField>> loadCalculatedFields() {
		if (calculatedFields == null)
			calculatedFields = super.loadCalculatedFields();
