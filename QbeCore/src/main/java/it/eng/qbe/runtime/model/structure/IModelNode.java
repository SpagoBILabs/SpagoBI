...
public interface IModelNode extends IModelObject {
	...
	/**
	 * Get the list of view in the path from the root to the node
	 * 
	 * @return
	 */
	...
	/**
	 * Gets the parent of the node from the structure. The difference with getParent() is that if the parent entity is a ModelView getLogicalParent() returns
	 * the view while getParent() returns the entity of the view that contains the node
	 */
