...
public class ModelViewEntityDescriptor implements IModelViewEntityDescriptor {
	...
	/**
	 * @param relationshipToViewsDescriptors
	 *            the relationshipToViewsDescriptors to set
	 */
	public void setRelationshipToViewsDescriptors(List<IModelViewRelationshipDescriptor> relationshipToViewsDescriptors) {
