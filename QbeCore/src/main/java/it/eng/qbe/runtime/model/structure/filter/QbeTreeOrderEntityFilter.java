...
package it.eng.qbe.runtime.model.structure.filter;
	...
	public List filter(IDataSource dataSource, List fields) {
		...
		Collections.sort(fields, new Comparator() {
			...
			public int compare(Object o1, Object o2) {
				...
				f2 = (IModelEntity) o2;
				/*
				 * p1 = properties.getProperty(f1, "position"); p2 = properties.getProperty(f2, "position");
				 *
				 * try { i1 = Integer.parseInt(p1); } catch(Throwable t) { i1 = Integer.MAX_VALUE; }
				 *
				 * try { i2 = Integer.parseInt(p2); } catch(Throwable t) { i2 = Integer.MAX_VALUE; }
				 */
