...
import it.eng.qbe.serialization.query.serializer.json.QueryJSONSerializer;
...
public abstract class AbstractQbeDataSet extends AbstractDataSet {
	...
	public void setQuery(Object query) {
		this.statement.setQuery((it.eng.qbe.runtime.query.Query) query);
	...
	public void updateParameters(it.eng.qbe.runtime.query.Query query, Map parameters) {
		logger.debug("IN");
