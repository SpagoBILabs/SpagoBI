...
/**
 * Comparator for the class PathChoice. Order the PathChoice by the length of the paths.toString. Id est it order by the string that represents the paths
 * 
...
public class PathChoicePathTextLengthComparator implements Comparator<PathChoice> {
	...
	private final String order;// ASC o DESC
