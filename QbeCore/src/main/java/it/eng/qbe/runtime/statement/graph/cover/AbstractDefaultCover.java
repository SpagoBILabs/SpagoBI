...
import it.eng.qbe.runtime.statement.graph.bean.PathChoicePathLengthComparator;
...
public abstract class AbstractDefaultCover implements IDefaultCoverGraph {
	...
	public abstract Map<IModelEntity, Set<GraphPath<IModelEntity, Relationship>>> getConnectingRelatiosnhips(
			Graph<IModelEntity, Relationship> rootEntitiesGraph, Set<IModelEntity> entities);
