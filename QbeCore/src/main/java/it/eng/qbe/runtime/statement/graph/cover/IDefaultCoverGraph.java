...
package it.eng.qbe.runtime.statement.graph.cover;
...
public interface IDefaultCoverGraph {
	 ...
	 *            the set of Ambiguous paths to activate if containd in the cover graph
	 * @param rootEntitiesGraph
	 *            the graph
	 * @param entities
	 *            the set of entities involved in the cover graph
	 */
	 ...
	 *            the list of paths contained in the default graph
	 * @param ambiguousModelField
	 *            the list of ambiguous paths
	 */
	 ...
	 *            the list of ambiguous paths
	 * @param withSubpaths
	 *            if false we remove the subpaths of the default cover graph. For example if the default cover graph contains the path A->B->C and for the field
	 *            B there are 3 possible paths: A->B, B->C and A->B->C. The algorithm set active only the last one.
	 */
	public void applyDefault(Map<IModelEntity, Set<GraphPath<IModelEntity, Relationship>>> defaultConnections, Set<ModelFieldPaths> ambiguousModelField,
			boolean withSubpaths);
