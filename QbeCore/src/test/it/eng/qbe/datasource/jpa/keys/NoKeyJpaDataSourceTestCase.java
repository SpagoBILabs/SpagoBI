 ...
 *
 */
public class NoKeyJpaDataSourceTestCase extends AbstractKeyJpaDataSourceTestCase {
	
	private static final String QBE_FILE = "test-resources/jpa/keys/noKey/dist/datamart.jar";
