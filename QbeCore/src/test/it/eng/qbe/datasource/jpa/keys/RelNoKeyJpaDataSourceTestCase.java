 ...
 *
 */
public class RelNoKeyJpaDataSourceTestCase extends AbstractKeyJpaDataSourceTestCase {
	
	private static final String QBE_FILE = "test-resources/jpa/keys/relNoKey/dist/datamart.jar";
