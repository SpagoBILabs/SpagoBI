 ...
 *
 */
public class SimpleKeyJpaDataSourceTestCase extends AbstractKeyJpaDataSourceTestCase {
	
	private static final String QBE_FILE = "test-resources/jpa/keys/simpleKey/dist/datamart.jar";
