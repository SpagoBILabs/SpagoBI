 ...
 *
 */
public class RelNoKeyJpaDataSourceTestCase extends AbstractViewJpaDataSourceTestCase {
	
	private static final String QBE_FILE = "test-resources/jpa/views/relNoKey/dist/datamart.jar";
