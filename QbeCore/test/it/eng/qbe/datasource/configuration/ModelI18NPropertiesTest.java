 ...
 *
 */
public class ModelI18NPropertiesTest extends QbeTestCase {
	...
	/**
	 * Test method for {@link it.eng.qbe.datasource.configuration.ModelI18NPropertiesDAOFileImpl#loadProperties(java.util.Locale)}.
	 */
	public void testLoadPropertiesLocale() {
		fail("Not yet implemented");
	}
	
	public static void main(String[] args) throws Exception {
		ModelI18NPropertiesTest testCase = new ModelI18NPropertiesTest();
		testCase.setUp();
		testCase.testLoadProperties();
	}
