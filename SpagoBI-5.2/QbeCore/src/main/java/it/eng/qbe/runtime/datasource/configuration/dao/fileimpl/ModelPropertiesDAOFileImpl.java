...
/**
 * Implementation of IModelPropertiesDAO that read model properties from a property file named qbe.properties stored withing the jar file passed in as argument
 * to the class costructore.
 *
 * NOTE: this class does not support interface methods saveProperties. Calling it will cause an exception
 *
 * @author Andrea Gioia
 */
