...
import it.eng.qbe.runtime.model.structure.ModelViewEntityDescriptor;
...
/**
 * Implementation of IViewsDAO that read model views from a json file named views.json stored within the jar file passed in as argument to the class
 * constructor.
 *
 * NOTE: this class does not support interface methods saveViews. Calling it will cause an exception
 *
 * @author Andrea Gioia
 */
