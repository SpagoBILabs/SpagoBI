...
public abstract class AbstractModelNode extends AbstractModelObject implements IModelNode {
	...
	/**
	 * Gets the parent of the node from the structure. The difference with getParent() is that if the parent entity is a ModelView: getPathParent() returns the
	 * view. getParent() returns the entity of the view that contains the node
	 */
	@Override
