...
public class TestJSONObject extends TestCase {
	...
	public void testMultipleThings() {
		try {
			...
			// + " .00000000000000001, "
					+ "2.00, 0.1, 2e100, -32,[],{}, \"string\"], " + "  to   : null, op : 'Good'," + "ten:10}";
	...
	public void _testToString_Indents() {
		try {
			...
			jsonobject.put("1239", new JSONObject().put("1fd23", new JSONObject()).put("12gfdgfg3", new JSONObject().put("f123", "123").put("12fgfg3", "abc")));
			assertEquals(
					"{\n    \"1234\": \"abc\",\n    \"1235\": {\"abc\": \"123\"},\n    \"123\": \"123\",\n    \"1239\": {\n        \"1fd23\": {},\n        \"12gfdgfg3\": {\n            \"f123\": \"123\",\n            \"12fgfg3\": \"abc\"\n        }\n    }\n}",
					jsonobject.toString(4));
			assertEquals("{\"1gg23\": \"123\"}", new JSONObject().put("1gg23", "123").toString(4));
	...
	public void testGetBoolean_NonBoolean() {
		try {
			...
			assertEquals("JSONObject[\"123\"] is not a Boolean.", e.getMessage());
		}
	}
	...
	public void testOptJSONObject_SimpleObject() {
		try {
			...
			assertEquals("{\"abc\":\"123\"}", jsonobject.optJSONObject("123").toString());
		} catch (JSONException e) {
			fail(e.getMessage());
		}
	}
	...
	public void testAppend() {
		try {
			...
			try {
				...
				assertEquals("JSONObject[string] is not a JSONArray.", e.getMessage());
			}
			assertEquals("{\"string\":\"123\",\"jsonarray\":[\"abc\",\"123\"],\"george\":[\"def\"]}", jsonobject.toString());
		} catch (JSONException e) {
			fail(e.getMessage());
		}
	}
	...
	public void testPutOnce() {
		try {
			jsonobject = new JSONObject();
			jsonobject.putOnce("abc", "123").putOnce("abcd", "1234").putOnce(null, "12345").putOnce("abcdef", null);
			assertEquals("{\"abc\":\"123\",\"abcd\":\"1234\"}", jsonobject.toString());
		} catch (JSONException e) {
			fail(e.getMessage());
		}
	}
