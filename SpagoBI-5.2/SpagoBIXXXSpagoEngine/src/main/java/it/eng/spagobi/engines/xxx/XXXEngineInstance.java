 ...
 * @author ...
 */
public class XXXEngineInstance extends AbstractEngineInstance {
	private JSONObject guiSettings;
	private List<String> includes;

	public XXXEngineInstance(Object template, Map env) {
		super( env );	
		try {
		...
		includes = XXXEngine.getConfig().getIncludes();
	}
	...
	public IEngineAnalysisState getAnalysisState() {
		throw new XXXEngineRuntimeException("Unsupported method [getAnalysisState]");
	}


	public void setAnalysisState(IEngineAnalysisState analysisState) {
		throw new XXXEngineRuntimeException("Unsupported method [setAnalysisState]");		
	}


	public void validate() throws SpagoBIEngineException {
		throw new XXXEngineRuntimeException("Unsupported method [validate]");		
	}
