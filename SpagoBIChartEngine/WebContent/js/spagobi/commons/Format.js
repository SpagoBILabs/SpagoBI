...
Ext.define('Sbi.chart.commons.Format', {
	statics: {
		/**
        ...
        , dateRenderer : function(format){
            return function(v){
                return Sbi.chart.commons.Format.date(v, format);
            };
        }
        ...
        , numberRenderer : function(format){
            return function(v){
                return Sbi.chart.commons.Format.number(v, format);
            };
        }
        ...
        , htmlRenderer : function(format){
            return function(v){
                return Sbi.chart.commons.Format.html(v, format);
            };
        }
