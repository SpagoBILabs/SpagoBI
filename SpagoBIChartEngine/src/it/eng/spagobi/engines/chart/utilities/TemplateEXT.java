...
public class TemplateEXT {
	...
	public static final String EXTCHART_LEGEND = "LEGEND";
	public static final String EXTCHART_AXIS_LIST = "AXIS_LIST";
	public static final String EXTCHART_AXIS = "AXIS";
	public static final String EXTCHART_SERIES_LIST = "SERIES_LIST";
	public static final String EXTCHART_SERIES = "SERIES";
	public static final String EXTCHART_SERIES_STYLE = "SERIES_STYLE";
	public static final String EXTCHART_SERIES_MARKERCONFIG = "SERIES_MARKERCONFIG";
	public static final String EXTCHART_SERIES_LABEL = "SERIES_LABEL";
