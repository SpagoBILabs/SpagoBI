...
Sbi.cockpit.editor.WidgetEditor = function(config) { 
	...
	if(Sbi.settings && Sbi.cockpit && Sbi.cockpit.editor && Sbi.cockpit.editor.widgetEditor) {
		defaultSettings = Ext.apply(defaultSettings, Sbi.cockpit.editor.widgetEditor);
	}
...
//	});
	...
	Sbi.cockpit.editor.WidgetEditor.superclass.constructor.call(this, c);	 		
...
/**
 * @class Sbi.cockpit.editor.WidgetEditor
 * @extends Ext.Panel
 * 
 * WorksheetDesignerPanel
 */
Ext.extend(Sbi.cockpit.editor.WidgetEditor, Ext.Panel, {
