...
Sbi.cockpit.editor.WidgetEditorMainPanel = function(config) { 
	...
	if(Sbi.settings && Sbi.cockpit && Sbi.cockpit.editor && Sbi.cockpit.editor.widgetEditorMainPanel) {
		defaultSettings = Ext.apply(defaultSettings, Sbi.cockpit.editor.widgetEditorMainPanel);
	}
	...
	Sbi.cockpit.editor.WidgetEditorMainPanel.superclass.constructor.call(this, c);
...
Ext.extend(Sbi.cockpit.editor.WidgetEditorMainPanel, Ext.Panel, {
