...
Sbi.cockpit.runtime.Widget = function(config) {	
	...
	// constructor
	Sbi.cockpit.runtime.Widget.superclass.constructor.call(this, c);
 ...
 * ...
 */
Ext.extend(Sbi.cockpit.runtime.Widget, Ext.Panel, {
	...
	/**
     * @property {Sbi.cockpit.runtime.WidgetPanel} parentContainer
