...
Sbi.cockpit.widgets.WidgetEditor = function(config) { 

	var defaultSettings = {
		//title: LN('Sbi.cockpit.widgets.WidgetEditor.title')
		engineAlreadyInitialized : false
		, border : false
	};

	if(Sbi.settings && Sbi.cockpit && Sbi.cockpit.widgets && Sbi.cockpit.widgets.widgetEditor) {
		defaultSettings = Ext.apply(defaultSettings, Sbi.cockpit.widgets.widgetEditor);
	}
...
//	});
	...
	Sbi.cockpit.widgets.WidgetEditor.superclass.constructor.call(this, c);	 		
...
/**
 * @class Sbi.cockpit.widgets.WidgetEditor
 * @extends Ext.Panel
 * 
 * WorksheetDesignerPanel
 */
Ext.extend(Sbi.cockpit.widgets.WidgetEditor, Ext.Panel, {
...
//		});
	...
	, initDesignToolPanel: function(config) {
		this.designToolsPanel = new Sbi.cockpit.widgets.WidgetEditorControlPanel({});
...
//			);
	...
	, initSheetsContainerPanel: function(config) {
		this.sheetsContainerPanel = new Sbi.cockpit.widgets.WidgetEditorMainPanel();
