 ...
 */
Ext.ns("SSbi.cockpit.widgets");

Sbi.cockpit.widgets.WidgetEditorControlPanel = function(config) { 

	var defaultSettings = {
		border: false
	};

	if(Sbi.settings && Sbi.cockpit && Sbi.cockpit.widgets && Sbi.cockpit.widgets.widgetEditorControlPanel) {
		defaultSettings = Ext.apply(defaultSettings, Sbi.cockpit.widgets.widgetEditorControlPanel);
	}
...
//	});
	...
	Sbi.cockpit.widgets.WidgetEditorControlPanel.superclass.constructor.call(this, c);
	
};

Ext.extend(Sbi.cockpit.widgets.WidgetEditorControlPanel, Ext.Panel, {
	...
	initPanels: function() {
		...
		this.designToolsPallettePanel = new Sbi.cockpit.widgets.WidgetEditorDesignerPalette({}); 
