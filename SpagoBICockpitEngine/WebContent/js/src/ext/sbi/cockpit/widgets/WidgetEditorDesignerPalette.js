...
Sbi.cockpit.widgets.WidgetEditorDesignerPalette = function(config) { 

	var defaultSettings = {
		border: false
	};

	if(Sbi.settings && Sbi.cockpit && Sbi.cockpit.widgets && Sbi.cockpit.widgets.widgetEditorDesignerPalette) {
		defaultSettings = Ext.apply(defaultSettings, Sbi.cockpit.widgets.widgetEditorDesignerPalette);
	}
	...
	c = this.initPanel();
	Sbi.cockpit.widgets.WidgetEditorDesignerPalette.superclass.constructor.call(this, c);	 		

};

Ext.extend(Sbi.cockpit.widgets.WidgetEditorDesignerPalette, Ext.Panel, {
