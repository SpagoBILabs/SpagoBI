...
Sbi.cockpit.widgets.WidgetManager = function(config) {
		...
		// constructor
		Sbi.cockpit.widgets.WidgetManager.superclass.constructor.call(this, c);
};

/**
 * @class Sbi.cockpit.widgets.WidgetManager
 ...
 * ...
 */
Ext.extend(Sbi.cockpit.widgets.WidgetManager, Ext.util.Observable, {
