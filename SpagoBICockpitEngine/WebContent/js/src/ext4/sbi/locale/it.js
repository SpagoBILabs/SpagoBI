...
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.title'] = 'Editor Associazioni';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.ds.columnColumn'] = 'Colonna';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.ds.columnType'] = 'Tipo';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.columnId'] = 'Identificativo';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.columnAssociation'] = 'Associazione';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.title'] = 'Lista Associazioni';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.add'] = 'Aggiungi';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.add.tooltip'] = 'Aggiungi Associazione';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.modify'] = 'Modifica';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.modify.tooltip'] = 'Modifica Associazione';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.delete'] = 'Cancella';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.delete.tooltip'] = 'Cancella Associazione';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.autodetect'] = 'Rilevamento automatico';
Sbi.locale.ln['sbi.cockpit.relationship.editor.wizard.list.autodetect.tooltip'] = 'Rilevamento automatico delle Associazioni';

Sbi.locale.ln['sbi.cockpit.relationship.editor.msg.modify'] = 'Per procedere con l\aggiornamento � necessario selezionare l\'associazione da modificare dalla lista!';
Sbi.locale.ln['sbi.cockpit.relationship.editor.msg.duplicate'] = 'Associazione gia esistente!';
Sbi.locale.ln['sbi.cockpit.relationship.editor.msg.differentType'] ='Non tutte le tipologie dei campi selezionati coincidono. Si intende proseguire con l\'aggiunta dell\'associazione?';
Sbi.locale.ln['sbi.cockpit.relationship.editor.msg.selectFields'] ='Selezionare le colonne per l\'associazione';
Sbi.locale.ln['sbi.cockpit.relationship.editor.msg.confirmDelete'] ='Confermi la cancellazione dell\'associazione ';