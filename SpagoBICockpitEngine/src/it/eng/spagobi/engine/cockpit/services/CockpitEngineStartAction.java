 ...
 */
public class CockpitEngineStartAction extends AbstractEngineStartServlet {

	private static final long serialVersionUID = 1L;

	private static final String ENGINE_NAME = "CockpitEngine";
	
	private static final String REQUEST_DISPATCHER_URL = "/WEB-INF/jsp/cockpit.jsp";
	
	/** Logger component. */
    private static transient Logger logger = Logger.getLogger(CockpitEngineStartAction.class);
