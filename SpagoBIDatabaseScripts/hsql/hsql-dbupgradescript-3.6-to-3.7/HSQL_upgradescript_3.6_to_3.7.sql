...
CREATE MEMORY TABLE SBI_META_MODELS (
       ID                   INTEGER NOT NULL,
...
CREATE MEMORY TABLE SBI_META_MODELS_VERSIONS (
        ID                   INTEGER NOT NULL,
...
CREATE MEMORY TABLE SBI_ARTIFACTS (
       ID                   INTEGER NOT NULL,
       NAME                 VARCHAR(100) NOT NULL,
       DESCR                VARCHAR(500) NULL,
...
CREATE MEMORY TABLE SBI_ARTIFACTS_VERSIONS (
        ID                   INTEGER NOT NULL,
