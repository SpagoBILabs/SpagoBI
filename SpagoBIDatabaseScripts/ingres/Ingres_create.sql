...
CREATE TABLE SBI_CONFIG (
	...
	VALUE_TYPE_ID 	INTEGER NULL, 
       ...
       CONSTRAINT XIF3SBI_CONFIG UNIQUE  (VALUE_TYPE_ID),
 	PRIMARY KEY (ID)
) ;\p\g
...
ALTER TABLE  SBI_KPI_DOCUMENTS  ADD FOREIGN KEY ( BIOBJ_ID ) REFERENCES  SBI_OBJECTS  ( BIOBJ_ID ) ON DELETE  RESTRICT ON UPDATE  RESTRICT;\p\g
...
ALTER TABLE  SBI_ALARM_EVENT  ADD FOREIGN KEY ( ALARM_ID ) REFERENCES  SBI_ALARM  ( ALARM_ID ) ON DELETE  RESTRICT ON UPDATE  RESTRICT;\p\g
