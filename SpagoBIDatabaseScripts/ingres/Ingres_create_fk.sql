...
ALTER TABLE SBI_KPI_VALUE ADD CONSTRAINT FK_SBI_KPI_VALUE_3 FOREIGN KEY (ORG_UNIT_ID) REFERENCES SBI_ORG_UNIT (ID) \p\g;
ALTER TABLE SBI_KPI_VALUE ADD CONSTRAINT FK_SBI_KPI_VALUE_4 FOREIGN KEY (HIERARCHY_ID) REFERENCES SBI_ORG_UNIT_HIERARCHIES (ID) \p\g;
