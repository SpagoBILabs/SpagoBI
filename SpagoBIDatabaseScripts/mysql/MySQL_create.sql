...
CREATE TABLE SBI_EXT_ROLES (
       ...
       DO_MASSIVE_EXPORT 			BOOLEAN DEFAULT TRUE,
       EDIT_WORKSHEET	 			BOOLEAN DEFAULT TRUE,
       MANAGE_USERS                 BOOLEAN DEFAULT FALSE,
       SEE_DOCUMENT_BROWSER 		BOOLEAN DEFAULT TRUE,
       SEE_FAVOURITES 				BOOLEAN DEFAULT TRUE,
       SEE_SUBSCRIPTIONS 			BOOLEAN DEFAULT TRUE,
       SEE_MY_DATA 					BOOLEAN DEFAULT TRUE,
       SEE_TODO_LIST 				BOOLEAN DEFAULT TRUE,
       CREATE_DOCUMENTS 			BOOLEAN DEFAULT TRUE,
       USER_IN              		VARCHAR(100) NOT NULL,
       USER_UP             			VARCHAR(100),
       USER_DE              		VARCHAR(100),
       TIME_IN              		TIMESTAMP NOT NULL,
...
ALTER TABLE SBI_COMMUNITY_USERS ADD CONSTRAINT FK_USER FOREIGN KEY (USER_ID) REFERENCES SBI_USER (ID) ON DELETE CASCADE;
