...
ALTER TABLE SBI_FUNCTIONALITIES_ROLES ADD CONSTRAINT FK_ROLE1 FOREIGN KEY (ROLE_ID) REFERENCES SBI_EXT_ROLES (EXT_ROLE_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE SBI_FUNCTIONALITIES_ROLES ADD CONSTRAINT FK_FUNCTIONALITY_1 FOREIGN KEY (FUNCTIONALITY_ID) REFERENCES SBI_FUNCTIONALITIES (ID) ON DELETE NO ACTION ON UPDATE NO ACTION;
