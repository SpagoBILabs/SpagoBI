...
concat('{"Query":"',ds_h.QUERY,'","queryScript":"',COALESCE(DS_H.QUERY_SCRIPT,''),'","queryScriptLanguage":"',COALESCE(QUERY_SCRIPT_LANGUAGE,''),'","dataSource":"',COALESCE(CAST((SELECT LABEL FROM SBI_DATA_SOURCE WHERE DS_ID = DATA_SOURCE_ID) AS CHAR),''),'"}') 
...
CONCAT('{"Script":"',COALESCE(DS_H.SCRIPT,''),'","scriptLanguage":"',COALESCE(DS_H.LANGUAGE_SCRIPT,''),'"}')
WHEN ds_h.OBJECT_TYPE = 'SbiCustomDataSet' then 
CONCAT('{"customData":"',COALESCE(DS_H.CUSTOM_DATA,'"{}"'),'","jClassName":"',COALESCE(DS_H.JCLASS_NAME,''),'"}')
WHEN ds_h.OBJECT_TYPE = 'SbiQbeDataSet' then 
CONCAT('{"qbeDatamarts":"',COALESCE(DS_H.DATAMARTS,''),'","qbeDataSource":"',COALESCE(CAST((SELECT LABEL FROM SBI_DATA_SOURCE WHERE DS_ID = DATA_SOURCE_ID) AS CHAR),''),'","qbeJSONQuery":"',COALESCE(DS_H.JSON_QUERY,''),'"}')
