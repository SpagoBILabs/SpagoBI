...
;
CREATE INDEX XAX1_SBI_FUNCTIONALITIES_ROLES ON SBI_FUNCTIONALITIES_ROLES (FUNCTIONALITY_ID)
;
...
ALTER TABLE SBI_META_MODELS ADD CONSTRAINT FK_ROLE1 FOREIGN KEY (ROLE_ID) REFERENCES SBI_EXT_ROLES (EXT_ROLE_ID);
ALTER TABLE SBI_META_MODELS ADD CONSTRAINT FK_FUNCTIONALITY_1 FOREIGN KEY (FUNCTIONALITY_ID) REFERENCES SBI_FUNCTIONALITIES (ID);
COMMIT;