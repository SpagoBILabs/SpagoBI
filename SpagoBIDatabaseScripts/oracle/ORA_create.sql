...
CREATE TABLE SBI_DATA_SET_HISTORY (
    ...
    QUERY   	   			CLOB,
    QUERY_SCRIPT   			CLOB DEFAULT NULL ,
...
CREATE TABLE SBI_EXT_ROLES (
	...
	DO_MASSIVE_EXPORT NUMBER(38,0) DEFAULT 1,
	EDIT_WORKSHEET  NUMBER(38,0) DEFAULT 1,
	MANAGE_USERS  NUMBER(38,0) DEFAULT 0,
	USER_IN              VARCHAR2(100) NOT NULL,
    USER_UP              VARCHAR2(100),
    USER_DE              VARCHAR2(100),
    TIME_IN              TIMESTAMP NOT NULL,
...
;
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT SBI_OBJECTS_7 FOREIGN KEY (DATA_SET_ID) REFERENCES SBI_DATA_SET (DS_ID) 
;
