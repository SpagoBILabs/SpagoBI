...
ALTER TABLE SBI_DATA_SET ADD COLUMN USER_IN VARCHAR2(100) NOT NULL;
ALTER TABLE SBI_DATA_SET ADD COLUMN USER_UP VARCHAR2(100); 
ALTER TABLE SBI_DATA_SET ADD COLUMN USER_DE VARCHAR2(100);
...
ALTER TABLE SBI_DATA_SET ADD COLUMN SBI_VERSION_IN VARCHAR2(10); 
ALTER TABLE SBI_DATA_SET ADD COLUMN SBI_VERSION_UP VARCHAR2(10); 
ALTER TABLE SBI_DATA_SET ADD COLUMN SBI_VERSION_DE VARCHAR2(10); 
ALTER TABLE SBI_DATA_SET ADD COLUMN META_VERSION VARCHAR2(100); 
ALTER TABLE SBI_DATA_SET ADD COLUMN ORGANIZATION VARCHAR2(20); 
