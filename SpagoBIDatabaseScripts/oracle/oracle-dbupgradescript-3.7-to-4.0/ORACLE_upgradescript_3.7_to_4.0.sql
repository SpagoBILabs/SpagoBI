...
ALTER TABLE SBI_EXT_ROLES ADD COLUMN SEE_DOCUMENT_BROWSER SMALLINT DEFAULT 1;
ALTER TABLE SBI_EXT_ROLES ADD COLUMN SEE_FAVOURITES 	SMALLINT DEFAULT 1;
ALTER TABLE SBI_EXT_ROLES ADD COLUMN SEE_SUBSCRIPTIONS 	SMALLINT DEFAULT 1;
ALTER TABLE SBI_EXT_ROLES ADD COLUMN SEE_MY_DATA 		SMALLINT DEFAULT 1;
ALTER TABLE SBI_EXT_ROLES ADD COLUMN SEE_TODO_LIST 		SMALLINT DEFAULT 1;
ALTER TABLE SBI_EXT_ROLES ADD COLUMN CREATE_DOCUMENTS 	SMALLINT DEFAULT 1;
