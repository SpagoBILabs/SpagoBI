...
commit;
INSERT INTO SBI_ORGANIZATION_ENGINE (USER_IN, TIME_IN, SBI_VERSION_IN, ENGINE_ID, ID)
SELECT 
'system' AS USER_IN,
SYSDATE AS TIME_IN, 
'5.0' AS SBI_VERSION_IN,
(SELECT engine_id from SBI_ENGINES where label = 'SpagoBIWhatIfEngine') AS ENGINE_ID, 
id AS ORGANIZATION_ID from SBI_ORGANIZATIONS;
COMMIT;

ALTER TABLE sbi_artifacts 
ADD COLUMN LOCKED SMALLINT NULL,
ADD COLUMN LOCKER VARCHAR2(100) NULL;
COMMIT;