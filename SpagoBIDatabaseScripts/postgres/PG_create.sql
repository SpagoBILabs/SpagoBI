...
Create table SBI_RESOURCES (
	RESOURCE_ID INTEGER DEFAULT nextval('RESOURCES_SEQ')  NOT NULL ,
...
Alter table SBI_KPI_VALUE add  Foreign Key (ORG_UNIT_ID) references SBI_ORG_UNIT (ID);
Alter table SBI_KPI_VALUE add  Foreign Key (HIERARCHY_ID) references SBI_ORG_UNIT_HIERARCHIES (ID);
