...
commit;
ALTER TABLE SBI_BINARY_CONTENTS DROP CONSTRAINT XAK1SBI_BINARY_CONTENTS;

UPDATE SBI_OBJECT_TEMPLATES set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_OBJECT_TEMPLATES DROP CONSTRAINT XAK1SBI_OBJECT_TEMPLATES;

UPDATE SBI_OBJECT_NOTES set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_OBJECT_NOTES DROP CONSTRAINT XAK1SBI_OBJECT_NOTES;

UPDATE SBI_SUBOBJECTS set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_SUBOBJECTS DROP CONSTRAINT XAK1SBI_SUBOBJECTS;

UPDATE SBI_SNAPSHOTS set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_SNAPSHOTS DROP CONSTRAINT XAK1SBI_SNAPSHOTS;

UPDATE SBI_USER_FUNC set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_USER_FUNC DROP CONSTRAINT XAK1SBI_USER_FUNC;

ALTER TABLE SBI_ROLE_TYPE_USER_FUNC DROP CONSTRAINT XAK1SBI_ROLE_TYPE_USER_FUNC;

UPDATE SBI_DOSSIER_PRES set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_DOSSIER_PRES DROP CONSTRAINT XAK1SBI_DOSSIER_PRES;

UPDATE SBI_DOSSIER_TEMP set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_DOSSIER_TEMP DROP CONSTRAINT XAK1SBI_DOSSIER_TEMP;

UPDATE SBI_DOSSIER_BIN_TEMP set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_DOSSIER_BIN_TEMP DROP CONSTRAINT XAK1SBI_DOSSIER_BIN_TEMP;

UPDATE SBI_DIST_LIST set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_DIST_LIST DROP CONSTRAINT XAK1SBI_SBI_DIST_LIST;
...
commit;
ALTER TABLE SBI_DIST_LIST_USER DROP CONSTRAINT XAK1SBI_DIST_LIST_USER;

UPDATE SBI_DIST_LIST_OBJECTS set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_DIST_LIST_OBJECTS DROP CONSTRAINT XAK1SBI_DIST_LIST_OBJECTS;

UPDATE SBI_REMEMBER_ME set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_REMEMBER_ME DROP CONSTRAINT XAK1SBI_REMEMBER_ME;

UPDATE SBI_DATA_SET set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_DATA_SET DROP CONSTRAINT XAK1SBI_DATA_SET;
...
commit;
ALTER TABLE SBI_KPI_ROLE DROP CONSTRAINT XAK1SBI_KPI_ROLE;

UPDATE SBI_KPI set ORGANIZATION = 'SPAGOBI';
commit;
ALTER TABLE SBI_KPI DROP CONSTRAINT XAK1SBI_KPI;
...
ALTER TABLE QRTZ_JOB_LISTENERS DROP CONSTRAINT QRTZ_JOB_LISTENERS_JOB_NAME_FKEY;
...
ALTER TABLE QRTZ_JOB_LISTENERS
  ADD CONSTRAINT QRTZ_JOB_LISTENERS_JOB_NAME_FKEY FOREIGN KEY (JOB_NAME, JOB_GROUP)
      REFERENCES QRTZ_JOB_DETAILS (JOB_NAME, JOB_GROUP);
ALTER TABLE QRTZ_TRIGGERS
  ADD CONSTRAINT QRTZ_TRIGGERS_JOB_NAME_FKEY FOREIGN KEY (JOB_NAME, JOB_GROUP)
      REFERENCES QRTZ_JOB_DETAILS (JOB_NAME, JOB_GROUP);
