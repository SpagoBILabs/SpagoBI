...
--DROP TABLE SBI_DATA_SET_HISTORY CASCADE;   -- da fare se tutto è andato ok! Sarà nella versione finale.
--DROP TABLE SBI_DATA_SET CASCADE;           -- da fare se tutto è andato ok! Sarà nella versione finale.
