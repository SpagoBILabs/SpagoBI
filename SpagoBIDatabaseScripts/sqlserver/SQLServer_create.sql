...
CREATE TABLE SBI_CONFIG (
 ...
 CREATE TABLE SBI_USER (
	...
	ID 						INTEGER NOT NULL,
	DT_PWD_BEGIN			DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	DT_PWD_END				DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	FLG_PWD_BLOCKED 		BIT,
	DT_LAST_ACCESS 			DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    USER_IN              	VARCHAR(100) NOT NULL,
    USER_UP             	 VARCHAR(100),
    USER_DE              	VARCHAR(100),
    TIME_IN              	DATETIME NOT NULL,
