CREATE TABLE hibernate_sequences (
  ...
  PRIMARY KEY CLUSTEREDCLUSTERED(SEQUENCE_NAME)
)ON [PRIMARY]
...
CREATE TABLE SBI_OBJ_PAR (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
       PRIMARY KEY CLUSTERED(OBJ_PAR_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_OBJECTS_RATING (
	   ...
	   META_VERSION         VARCHAR(100),
	   ORGANIZATION         VARCHAR(20), 
	 PRIMARY KEY CLUSTERED(USER_ID, OBJ_ID)
) ON [PRIMARY] 
...
CREATE TABLE SBI_AUDIT ( 
		...
		EXECUTION_START 	TIMESTAMP DEFAULT NULL,
		EXECUTION_END 		TIMESTAMP DEFAULT NULL,
...
CREATE TABLE SBI_VIEWPOINTS (
        ...
        META_VERSION         VARCHAR(100),
        ORGANIZATION         VARCHAR(20),   
        CONSTRAINT XPKSBI_VIEWPOINTS PRIMARY KEY CLUSTERED(VP_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_DATA_SOURCE (
        ...
        CONSTRAINT XPKSBI_DATA_SOURCE PRIMARY KEY CLUSTERED(DS_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_OBJECT_TEMPLATES (
        ...
        PRIMARY KEY CLUSTERED(OBJ_TEMP_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_OBJECT_NOTES (
       ...
       PRIMARY KEY CLUSTERED(OBJ_NOTE_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_SUBOBJECTS (
       ...
       PRIMARY KEY CLUSTERED(SUBOBJ_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_SNAPSHOTS (
       ...
       CONSTRAINT XPKSBI_SNAPSHOTS PRIMARY KEY CLUSTERED(SNAP_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_USER_FUNC (
       ...
       CONSTRAINT XPKSBI_USER_FUNCTIONALITY PRIMARY KEY CLUSTERED(USER_FUNCT_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ROLE_TYPE_USER_FUNC (
        ...
        CONSTRAINT XPKSBI_ROLE_TYPE_USER_FUNCTIONALITY PRIMARY KEY CLUSTERED(ROLE_TYPE_ID,USER_FUNCT_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_MENU_ROLE (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),            
       PRIMARY KEY CLUSTERED(MENU_ID, EXT_ROLE_ID)
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_ROLE  (
       ...
       PRIMARY KEY CLUSTERED( ID_KPI_ROLE )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_DOCUMENTS  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	   PRIMARY KEY CLUSTERED( ID_KPI_DOC )
) ON [PRIMARY]
...
CREATE TABLE  SBI_MEASURE_UNIT  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	   PRIMARY KEY CLUSTERED( ID_MEASURE_UNIT )
) ON [PRIMARY]
...
CREATE TABLE  SBI_THRESHOLD  (
	   ...
	   CONSTRAINT XIF1SBI_THRESHOLD UNIQUE  ( CODE ),
 	   PRIMARY KEY CLUSTERED( THRESHOLD_ID )
) ON [PRIMARY]
...
CREATE TABLE  SBI_THRESHOLD_VALUE  (
	   ...
	   CONSTRAINT XIF1SBI_THRESHOLD_VALUE UNIQUE  ( LABEL ,THRESHOLD_ID ),
 	   PRIMARY KEY CLUSTERED( ID_THRESHOLD_VALUE )
) ON [PRIMARY]
 ...
 CREATE TABLE  SBI_KPI_MODEL  (
       ...
       PRIMARY KEY CLUSTERED( KPI_MODEL_ID )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_PERIODICITY  (
	   ...
	   CONSTRAINT XIF1SBI_KPI_PERIODICITY UNIQUE  ( NAME ),
 	   PRIMARY KEY CLUSTERED( ID_KPI_PERIODICITY )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_INSTANCE  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	   PRIMARY KEY CLUSTERED( ID_KPI_INSTANCE )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_INST_PERIOD  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),      
 	   PRIMARY KEY CLUSTERED( KPI_INST_PERIOD_ID )
)
ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_INSTANCE_HISTORY  (
       ...
       ORGANIZATION         VARCHAR(20),     	
		CONSTRAINT XIF1SBI_KPI_INST_HISTORY UNIQUE  ( ID_KPI_INSTANCE_HISTORY ),
 		PRIMARY KEY CLUSTERED( ID_KPI_INSTANCE_HISTORY )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_VALUE  (
 ...
 PRIMARY KEY CLUSTERED( ID_KPI_INSTANCE_VALUE )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_MODEL_INST  (
 ...
 PRIMARY KEY CLUSTERED( KPI_MODEL_INST )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_MODEL_RESOURCES  (
	 ...
	 KPI_MODEL_INST  INTEGER NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 PRIMARY KEY CLUSTERED( KPI_MODEL_RESOURCES_ID )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_ALARM_EVENT  (
	 ...
	 KPI_INSTANCE_ID  INTEGER,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 PRIMARY KEY CLUSTERED( ALARM_EVENT_ID )
) ON [PRIMARY]
...
CREATE TABLE  SBI_ALARM_CONTACT  (
 ...
 PRIMARY KEY CLUSTERED( ALARM_CONTACT_ID )
) ON [PRIMARY]

CREATE TABLE SBI_ALARM_DISTRIBUTION (
	ALARM_CONTACT_ID INTEGER NOT NULL,
	ALARM_ID INTEGER NOT NULL,  
 	PRIMARY KEY CLUSTERED(ALARM_CONTACT_ID,ALARM_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_UDP_VALUE (
    ...
    REFERENCE_ID	   INTEGER NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),         
 	PRIMARY KEY CLUSTERED(UDP_VALUE_ID)
)ON [PRIMARY]
 ...
 CREATE TABLE SBI_KPI_REL (
  ...
  PARAMETER VARCHAR(100),
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),      
  PRIMARY KEY CLUSTERED(KPI_REL_ID)
)ON [PRIMARY]
 ...
 CREATE TABLE SBI_KPI_ERROR (
  ...
  PARAMETERS VARCHAR(1000),
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),       
  PRIMARY KEY CLUSTERED(KPI_ERROR_ID)
)ON [PRIMARY]
