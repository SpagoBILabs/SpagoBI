...
CREATE TABLE SBI_OBJ_STATE (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),      
       CONSTRAINT PK_SBI_OBJ_STATE PRIMARY KEY CLUSTERED(BIOBJ_ID, STATE_ID, START_DT)
) ON [PRIMARY]
...
CREATE TABLE SBI_OBJECTS_RATING (
	   ...
	   META_VERSION         VARCHAR(100),
	   ORGANIZATION         VARCHAR(20), 
	 CONSTRAINT	PK_SBI_OBJECTS_RATING PRIMARY KEY  CLUSTERED(USER_ID, OBJ_ID)
) ON [PRIMARY] 
...
CREATE TABLE SBI_EVENTS_ROLES (
       ...
       ROLE_ID             INTEGER NOT NULL,      
       CONSTRAINT PK_SBI_EVENTS_ROLES PRIMARY KEY CLUSTERED(EVENT_ID, ROLE_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_AUDIT ( 
        ...
        META_VERSION        VARCHAR(100),
        ORGANIZATION        VARCHAR(20), 		
		CONSTRAINT PK_SBI_AUDIT PRIMARY KEY CLUSTERED(ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ACTIVITY_MONITORING (
	  ...
	  INFO 			VARCHAR(400),
	  CONSTRAINT PK_SBI_ACTIVITY_MONITORING PRIMARY KEY  CLUSTERED(ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_GEO_MAP_FEATURES (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
       CONSTRAINT PK_SBI_GEO_MAP_FEATURES PRIMARY KEY CLUSTERED(MAP_ID, FEATURE_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_VIEWPOINTS (
        ...
        META_VERSION         VARCHAR(100),
        ORGANIZATION         VARCHAR(20),   
        CONSTRAINT PKSBI_VIEWPOINTS PRIMARY KEY CLUSTERED(VP_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_DATA_SOURCE (
        ...
        META_VERSION         VARCHAR(100),
        ORGANIZATION         VARCHAR(20),   
        CONSTRAINT AK1SBI_DATA_SOURCE UNIQUE  (LABEL, ORGANIZATION),
        CONSTRAINT PKSBI_DATA_SOURCE PRIMARY KEY CLUSTERED(DS_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_BINARY_CONTENTS (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),	
       CONSTRAINT AK1SBI_BINARY_CONTENTS UNIQUE  (BIN_ID),
       CONSTRAINT PK_SBI_BINARY_CONTENTS PRIMARY KEY  CLUSTERED(BIN_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_OBJECT_TEMPLATES (
        ...
        META_VERSION         VARCHAR(100),
        ORGANIZATION         VARCHAR(20),   
        CONSTRAINT AK1SBI_OBJECT_TEMPLATES UNIQUE  (OBJ_TEMP_ID),
        CONSTRAINT PK_SBI_OBJECT_TEMPLATES PRIMARY KEY  CLUSTERED(OBJ_TEMP_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_OBJECT_NOTES (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),  
       CONSTRAINT AK1SBI_OBJECT_NOTES UNIQUE  (OBJ_NOTE_ID),
       CONSTRAINT PK_SBI_OBJECT_NOTES PRIMARY KEY  CLUSTERED(OBJ_NOTE_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_SUBOBJECTS (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),    
       CONSTRAINT AK1SBI_SUBOBJECTS UNIQUE  (SUBOBJ_ID),
       CONSTRAINT  PK_SBI_SUBOBJECTS PRIMARY KEY  CLUSTERED(SUBOBJ_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_SNAPSHOTS (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),  
       CONSTRAINT AK1SBI_SNAPSHOTS UNIQUE  (SNAP_ID),
       CONSTRAINT PKSBI_SNAPSHOTS PRIMARY KEY CLUSTERED(SNAP_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_USER_FUNC (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),    
       CONSTRAINT AK1SBI_USER_FUNC UNIQUE  (USER_FUNCT_ID),
       CONSTRAINT PKSBI_USER_FUNCTIONALITY PRIMARY KEY CLUSTERED(USER_FUNCT_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ROLE_TYPE_USER_FUNC (
		ROLE_TYPE_ID 		INTEGER NOT NULL,
		USER_FUNCT_ID 	    INTEGER NOT NULL,   
		CONSTRAINT AK1SBI_ROLE_TYPE_USER_FUNC UNIQUE  (ROLE_TYPE_ID,USER_FUNCT_ID),
        CONSTRAINT PKSBI_ROLE_TYPE_USER_FUNCTIONALITY PRIMARY KEY CLUSTERED(ROLE_TYPE_ID,USER_FUNCT_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_DOSSIER_PRES (
        ...
        META_VERSION         VARCHAR(100),
        ORGANIZATION         VARCHAR(20),  
        CONSTRAINT AK1SBI_DOSSIER_PRES UNIQUE  (PRESENTATION_ID),
...
CREATE TABLE SBI_DOSSIER_TEMP (
        ...
        META_VERSION         VARCHAR(100),
        ORGANIZATION         VARCHAR(20),  
		CONSTRAINT AK1SBI_DOSSIER_TEMP UNIQUE  (PART_ID),    
...
CREATE TABLE SBI_DOSSIER_BIN_TEMP (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),    
       CONSTRAINT AK1SBI_DOSSIER_BIN_TEMP UNIQUE  (BIN_ID), 
...
CREATE TABLE SBI_DIST_LIST (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
       CONSTRAINT AK1SBI_SBI_DIST_LIST UNIQUE  (DL_ID, ORGANIZATION), 
       CONSTRAINT PK_SBI_DIST_LIST PRIMARY KEY  CLUSTERED(DL_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_DIST_LIST_USER (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20), 
       CONSTRAINT AK1SBI_DIST_LIST_USER UNIQUE  (DLU_ID), 
       CONSTRAINT AK1SBI_DL_USER UNIQUE  (LIST_ID, USER_ID),
	   CONSTRAINT PK_SBI_DIST_LIST_USER PRIMARY KEY  CLUSTERED(DLU_ID)       
) ON [PRIMARY]
...
CREATE TABLE SBI_DIST_LIST_OBJECTS (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),           
       CONSTRAINT AK1SBI_DIST_LIST_OBJECTS UNIQUE  (REL_ID), 
	   CONSTRAINT PK_SBI_DIST_LIST_OBJECTS PRIMARY KEY  CLUSTERED(REL_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_REMEMBER_ME (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),  
       CONSTRAINT AK1SBI_REMEMBER_ME UNIQUE  (ID),
...
CREATE TABLE SBI_DATA_SET (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),  	
       CONSTRAINT AK1SBI_DATA_SET UNIQUE  (LABEL, ORGANIZATION),
...
CREATE TABLE SBI_DATA_SET_HISTORY (
    ...
    CONSTRAINT PK_SBI_DATA_SET_HISTORY PRIMARY KEY  CLUSTERED(DS_H_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_MENU_ROLE (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),            
       CONSTRAINT PK_SBI_MENU_ROLE PRIMARY KEY  CLUSTERED(MENU_ID, EXT_ROLE_ID)
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_ROLE  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
	   CONSTRAINT AK1SBI_KPI_ROLE UNIQUE  ( ID_KPI_ROLE ),
       CONSTRAINT PK_SBI_KPI_ROLE PRIMARY KEY  CLUSTERED( ID_KPI_ROLE )
) ON [PRIMARY]
...
CREATE TABLE SBI_KPI  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
       CONSTRAINT AK1SBI_KPI UNIQUE  ( CODE ),
 	   CONSTRAINT PK_SBI_KPI PRIMARY KEY  CLUSTERED( KPI_ID )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_DOCUMENTS  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	   CONSTRAINT PK_SBI_KPI_DOCUMENTS PRIMARY KEY  CLUSTERED( ID_KPI_DOC )
) ON [PRIMARY]
...
CREATE TABLE  SBI_MEASURE_UNIT  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	   CONSTRAINT PK_SBI_MEASURE_UNIT PRIMARY KEY CLUSTERED( ID_MEASURE_UNIT )
) ON [PRIMARY]
...
CREATE TABLE  SBI_THRESHOLD  (
	   ...
	   CONSTRAINT XIF1SBI_THRESHOLD UNIQUE  ( CODE, ORGANIZATION ),
 	   CONSTRAINT PK_SBI_THRESHOLD PRIMARY KEY  CLUSTERED( THRESHOLD_ID )
) ON [PRIMARY]
...
CREATE TABLE  SBI_THRESHOLD_VALUE  (
	   ...
	   CONSTRAINT XIF1SBI_THRESHOLD_VALUE UNIQUE  ( LABEL ,THRESHOLD_ID ),
 	   CONSTRAINT PK_SBI_THRESHOLD_VALUE PRIMARY KEY  CLUSTERED( ID_THRESHOLD_VALUE )
) ON [PRIMARY]
 ...
 CREATE TABLE  SBI_KPI_MODEL  (
       ...
       CONSTRAINT PKSBI_KPI_MODEL PRIMARY KEY  CLUSTERED( KPI_MODEL_ID )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_PERIODICITY  (
	   ...
	   CONSTRAINT XIF1SBI_KPI_PERIODICITY UNIQUE  ( NAME, ORGANIZATION),
 	   CONSTRAINT PK_SBI_KPI_PERIODICITY PRIMARY KEY CLUSTERED( ID_KPI_PERIODICITY )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_INSTANCE  (
	   ...
	   WEIGHT  				NUMERIC,
	   TARGET  				NUMERIC,
	   BEGIN_DT  			DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
       USER_IN              VARCHAR(100) NOT NULL,
       USER_UP              VARCHAR(100),
       USER_DE              VARCHAR(100),
       TIME_IN              DATETIME NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	   CONSTRAINT PK_SBI_KPI_INSTANCE PRIMARY KEY  CLUSTERED( ID_KPI_INSTANCE )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_INST_PERIOD  (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),      
 	   CONSTRAINT PK_SBI_KPI_INST_PERIOD PRIMARY KEY  CLUSTERED( KPI_INST_PERIOD_ID )
)
ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_INSTANCE_HISTORY  (
       ...
       ORGANIZATION         VARCHAR(20),     	
		CONSTRAINT XIF1SBI_KPI_INST_HISTORY UNIQUE  ( ID_KPI_INSTANCE_HISTORY ),
 		CONSTRAINT PK_SBI_KPI_INSTANCE_HISTORY PRIMARY KEY  CLUSTERED( ID_KPI_INSTANCE_HISTORY )
) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_VALUE  (
	...
	CONSTRAINT XIF1SBI_KPI_VALUE UNIQUE  ( ID_KPI_INSTANCE_VALUE ),
 	CONSTRAINT PK_SBI_KPI_VALUE PRIMARY KEY  CLUSTERED( ID_KPI_INSTANCE_VALUE )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_MODEL_INST  (
    ...
    CONSTRAINT XAK2SBI_KPI_MODEL_INST UNIQUE  ( LABEL, ORGANIZATION ),
 	CONSTRAINT PK_SBI_KPI_MODEL_INST PRIMARY KEY  CLUSTERED( KPI_MODEL_INST )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_RESOURCES  (
	...
	CONSTRAINT XIF1SBI_RESOURCES UNIQUE  ( RESOURCE_CODE, ORGANIZATION ),
 	CONSTRAINT PK_SBI_RESOURCES PRIMARY KEY  CLUSTERED( RESOURCE_ID )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_KPI_MODEL_RESOURCES  (
	 ...
	 KPI_MODEL_INST  INTEGER NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	CONSTRAINT PK_SBI_KPI_MODEL_RESOURCES PRIMARY KEY  CLUSTERED( KPI_MODEL_RESOURCES_ID )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_ALARM  (
	 ...
	 ID_THRESHOLD_VALUE  INTEGER ,
	   ...
	   CONSTRAINT XIF1SBI_ALARM UNIQUE  ( LABEL, ORGANIZATION ),
 	   CONSTRAINT PK_SBI_ALARM PRIMARY KEY  CLUSTERED( ALARM_ID )
 ) ON [PRIMARY]
...
CREATE TABLE  SBI_ALARM_EVENT  (
     ...
     META_VERSION       VARCHAR(100),
     ORGANIZATION       VARCHAR(20),     
 CONSTRAINT PK_SBI_ALARM_EVENT PRIMARY KEY  CLUSTERED( ALARM_EVENT_ID )
) ON [PRIMARY]
...
CREATE TABLE  SBI_ALARM_CONTACT  (
 ...
 CONSTRAINT PK_SBI_ALARM_CONTACT PRIMARY KEY  CLUSTERED( ALARM_CONTACT_ID )
) ON [PRIMARY]

CREATE TABLE SBI_ALARM_DISTRIBUTION (
	ALARM_CONTACT_ID INTEGER NOT NULL,
	ALARM_ID INTEGER NOT NULL,  
 	CONSTRAINT PK_SBI_ALARM_DISTRIBUTION PRIMARY KEY  CLUSTERED(ALARM_CONTACT_ID,ALARM_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_EXPORTERS (
  ...
  CONSTRAINT PK_EXPORTERS PRIMARY KEY CLUSTERED(ENGINE_ID, DOMAIN_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_CONFIG (
	...
	VALUE_TYPE_ID 	INTEGER NULL, 
       ...
       CONSTRAINT XAK1SBI_CONFIG UNIQUE  (LABEL),
 		CONSTRAINT PK_SBI_CONFIG PRIMARY KEY  CLUSTERED(ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ATTRIBUTE (
	...
	ATTRIBUTE_ID INTEGER NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	CONSTRAINT PK_SBI_ATTRIBUTE PRIMARY KEY CLUSTERED(ATTRIBUTE_ID, ORGANIZATION)
) ON [PRIMARY]
...
CREATE TABLE SBI_USER_ATTRIBUTES (
	...
	ATTRIBUTE_VALUE VARCHAR(500),
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	CONSTRAINT PK_SBI_USER_ATTRIBUTES PRIMARY KEY CLUSTERED(ID,ATTRIBUTE_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_EXT_USER_ROLES (
	...
	EXT_ROLE_ID INTEGER NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     	
 	CONSTRAINT PK_SBI_EXT_USER_ROLES PRIMARY KEY CLUSTERED(ID,EXT_ROLE_ID)
) ON [PRIMARY]
	...
	IS_MULTIVALUE   BIT DEFAULT 0,   
       ...
       ORGANIZATION         VARCHAR(20),    
        CONSTRAINT XAK1SBI_UDP UNIQUE  (LABEL, ORGANIZATION),
 		CONSTRAINT PK_SBI_UDP PRIMARY KEY  CLUSTERED(UDP_ID)
)ON [PRIMARY]
...
CREATE TABLE SBI_UDP_VALUE (
    ...
    REFERENCE_ID	   INTEGER NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),         
 	CONSTRAINT PK_SBI_UDP_VALUE PRIMARY KEY  CLUSTERED(UDP_VALUE_ID)
)ON [PRIMARY]
 ...
 CREATE TABLE SBI_KPI_REL (
  ...
  PARAMETER VARCHAR(100),
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),      
  CONSTRAINT PK_SBI_KPI_REL PRIMARY KEY  CLUSTERED(KPI_REL_ID)
)ON [PRIMARY]
...
CREATE TABLE SBI_ORG_UNIT (
  ...
  CONSTRAINT PK_SBI_ORG_UNIT PRIMARY KEY(ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ORG_UNIT_HIERARCHIES (
  ...
  CONSTRAINT PK_SBI_ORG_UNIT_HIERARCHIES PRIMARY KEY(ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ORG_UNIT_NODES (
  ...
  PATH VARCHAR(4000) NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),      
  CONSTRAINT PK_SBI_ORG_UNIT_NODES PRIMARY KEY(NODE_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ORG_UNIT_GRANT (
  ...
  CONSTRAINT PK_SBI_ORG_UNIT_GRANT PRIMARY KEY(ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_ORG_UNIT_GRANT_NODES (
  ...
  GRANT_ID INTEGER NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),      
  CONSTRAINT PK_SBI_ORG_UNIT_GRANT_NODES PRIMARY KEY(NODE_ID, KPI_MODEL_INST_NODE_ID, GRANT_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_PROGRESS_THREAD (
       ...
       TYPE                 VARCHAR(200),	
    CONSTRAINT PK_SBI_PROGRESS_THREAD PRIMARY KEY CLUSTERED(PROGRESS_THREAD_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_OBJ_PARVIEW (
  OBJ_PAR_ID INTEGER NOT NULL,
   ...
   PROG INTEGER,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),    
  CONSTRAINT PK_SBI_OBJ_PARVIEW PRIMARY KEY CLUSTERED ( OBJ_PAR_ID ,  OBJ_PAR_FATHER_ID ,  OPERATION, COMPARE_VALUE )
)ON [PRIMARY];
...
CREATE TABLE SBI_I18N_MESSAGES (
  ...
  META_VERSION         VARCHAR(100),
  ORGANIZATION         VARCHAR(20),
  CONSTRAINT PK_SBI_I18N_MESSAGES PRIMARY KEY(LANGUAGE_CD, LABEL, ORGANIZATION)
) ON [PRIMARY];
...
ALTER TABLE SBI_LOV ADD CONSTRAINT FK_SBI_LOV_2 FOREIGN KEY ( DATASET_ID ) REFERENCES SBI_DATA_SET ( DS_ID );
...
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT FK_SBI_OBJECTS_7 FOREIGN KEY  ( DATA_SET_ID ) REFERENCES SBI_DATA_SET ( DS_ID ) ;
...
ALTER TABLE SBI_DATA_SET_HISTORY ADD CONSTRAINT FK_SBI_DATA_SET_CAT  FOREIGN KEY  (CATEGORY_ID) REFERENCES SBI_DOMAINS (VALUE_ID)  ;
...
-- DEFINITION
ALTER TABLE  SBI_THRESHOLD  ADD CONSTRAINT FK_SBI_THRESHOLD_1 FOREIGN KEY ( THRESHOLD_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_MEASURE_UNIT  ADD CONSTRAINT FK_SBI_MEASURE_UNIT_1 FOREIGN KEY ( SCALE_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_THRESHOLD_VALUE  ADD CONSTRAINT FK_SBI_THRESHOLD_VALUE_1 FOREIGN KEY ( SEVERITY_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_THRESHOLD_VALUE  ADD CONSTRAINT FK_SBI_THRESHOLD_VALUE_2 FOREIGN KEY ( THRESHOLD_ID ) REFERENCES  SBI_THRESHOLD  ( THRESHOLD_ID ) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE  SBI_KPI_ROLE  ADD CONSTRAINT FK_SBI_KPI_ROLE_1 FOREIGN KEY ( EXT_ROLE_ID ) REFERENCES  SBI_EXT_ROLES  ( EXT_ROLE_ID )  ;
ALTER TABLE  SBI_KPI_ROLE  ADD CONSTRAINT FK_SBI_KPI_ROLE_2 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID )  ;
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_1 FOREIGN KEY ( ID_MEASURE_UNIT ) REFERENCES  SBI_MEASURE_UNIT  ( ID_MEASURE_UNIT )  ;
...
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_3 FOREIGN KEY ( DS_ID ) REFERENCES  SBI_DATA_SET  ( DS_ID )  ;
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_4 FOREIGN KEY ( ID_KPI_PARENT ) REFERENCES  SBI_KPI  ( KPI_ID )  ;
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_5 FOREIGN KEY ( KPI_TYPE ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_6 FOREIGN KEY ( METRIC_SCALE_TYPE ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_7 FOREIGN KEY ( MEASURE_TYPE ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
...
ALTER TABLE  SBI_KPI_DOCUMENTS  ADD CONSTRAINT FK_SBI_KPI_DOCUMENTS_2 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID )  ;
ALTER TABLE  SBI_KPI_MODEL  ADD CONSTRAINT FK_SBI_KPI_MODEL_1 FOREIGN KEY ( KPI_PARENT_MODEL_ID ) REFERENCES  SBI_KPI_MODEL  ( KPI_MODEL_ID )  ;
ALTER TABLE  SBI_KPI_MODEL  ADD CONSTRAINT FK_SBI_KPI_MODEL_2 FOREIGN KEY ( KPI_MODEL_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_KPI_MODEL  ADD CONSTRAINT FK_SBI_KPI_MODEL_3 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID )  ;

-- INSTANCE
ALTER TABLE  SBI_KPI_INSTANCE  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_1 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID )  ;
ALTER TABLE  SBI_KPI_INSTANCE  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_2 FOREIGN KEY ( CHART_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_KPI_INSTANCE  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_3 FOREIGN KEY ( ID_MEASURE_UNIT ) REFERENCES  SBI_MEASURE_UNIT  ( ID_MEASURE_UNIT )  ;
ALTER TABLE  SBI_KPI_INSTANCE  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_4 FOREIGN KEY ( THRESHOLD_ID ) REFERENCES  SBI_THRESHOLD  ( THRESHOLD_ID )  ;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_1 FOREIGN KEY ( ID_MEASURE_UNIT ) REFERENCES  SBI_MEASURE_UNIT  ( ID_MEASURE_UNIT )  ;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_2 FOREIGN KEY ( THRESHOLD_ID ) REFERENCES  SBI_THRESHOLD  ( THRESHOLD_ID )  ;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_3 FOREIGN KEY ( CHART_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_4 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE )  ;
ALTER TABLE  SBI_KPI_MODEL_INST  ADD CONSTRAINT FK_SBI_KPI_MODEL_INST_1 FOREIGN KEY ( KPI_MODEL_INST_PARENT ) REFERENCES  SBI_KPI_MODEL_INST  ( KPI_MODEL_INST )  ;
ALTER TABLE  SBI_KPI_MODEL_INST  ADD CONSTRAINT FK_SBI_KPI_MODEL_INST_2 FOREIGN KEY ( KPI_MODEL_ID ) REFERENCES  SBI_KPI_MODEL  ( KPI_MODEL_ID )  ;
ALTER TABLE  SBI_KPI_MODEL_INST  ADD CONSTRAINT FK_SBI_KPI_MODEL_INST_3 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE )  ;
ALTER TABLE  SBI_KPI_MODEL_RESOURCES  ADD CONSTRAINT FK_SBI_KPI_MODEL_RESOURCES_1 FOREIGN KEY ( KPI_MODEL_INST ) REFERENCES  SBI_KPI_MODEL_INST  ( KPI_MODEL_INST )  ;
ALTER TABLE  SBI_KPI_MODEL_RESOURCES  ADD CONSTRAINT FK_SBI_KPI_MODEL_RESOURCES_2 FOREIGN KEY ( RESOURCE_ID ) REFERENCES  SBI_RESOURCES  ( RESOURCE_ID )  ;
ALTER TABLE  SBI_RESOURCES  ADD CONSTRAINT FK_SBI_RESOURCES_1 FOREIGN KEY ( RESOURCE_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_KPI_VALUE  ADD CONSTRAINT FK_SBI_KPI_VALUE_1 FOREIGN KEY ( RESOURCE_ID ) REFERENCES  SBI_RESOURCES  ( RESOURCE_ID )  ;
ALTER TABLE  SBI_KPI_VALUE  ADD CONSTRAINT FK_SBI_KPI_VALUE_2 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE )  ;
ALTER TABLE  SBI_KPI_INST_PERIOD  ADD CONSTRAINT FK_SBI_KPI_INST_PERIOD_1 FOREIGN KEY ( PERIODICITY_ID ) REFERENCES  SBI_KPI_PERIODICITY  ( ID_KPI_PERIODICITY )  ;
ALTER TABLE  SBI_KPI_INST_PERIOD  ADD CONSTRAINT FK_SBI_KPI_INST_PERIOD_2 FOREIGN KEY  ( KPI_INSTANCE_ID ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE )  ;

-- ALARM
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_1 FOREIGN KEY ( MODALITY_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_2 FOREIGN KEY ( DOCUMENT_ID ) REFERENCES  SBI_OBJECTS  ( BIOBJ_ID )  ;
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_3 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE )  ;
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_4 FOREIGN KEY ( ID_THRESHOLD_VALUE ) REFERENCES  SBI_THRESHOLD_VALUE  ( ID_THRESHOLD_VALUE )  ;
...
ALTER TABLE  SBI_ALARM_DISTRIBUTION  ADD CONSTRAINT FK_SBI_ALARM_DISTRIBUTION_1 FOREIGN KEY ( ALARM_ID ) REFERENCES  SBI_ALARM  ( ALARM_ID )  ;
ALTER TABLE  SBI_ALARM_DISTRIBUTION  ADD CONSTRAINT FK_SBI_ALARM_DISTRIBUTION_2 FOREIGN KEY ( ALARM_CONTACT_ID ) REFERENCES  SBI_ALARM_CONTACT  ( ALARM_CONTACT_ID )  ;

ALTER TABLE  SBI_EXPORTERS  ADD CONSTRAINT FK_SBI_EXPORTERS_1 FOREIGN KEY ( ENGINE_ID ) REFERENCES  SBI_ENGINES  ( ENGINE_ID )  ;
ALTER TABLE  SBI_EXPORTERS  ADD CONSTRAINT FK_SBI_EXPORTERS_2 FOREIGN KEY ( DOMAIN_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID )  ;

ALTER TABLE SBI_CONFIG ADD CONSTRAINT FK_SBI_CONFIG_1 FOREIGN KEY  ( VALUE_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ;
ALTER TABLE SBI_USER_ATTRIBUTES ADD CONSTRAINT FK_SBI_USER_ATTRIBUTES_1 FOREIGN KEY  (ID) REFERENCES SBI_USER (ID) ON DELETE CASCADE ;
ALTER TABLE SBI_EXT_USER_ROLES ADD CONSTRAINT FK_SBI_EXT_USER_ROLES_1 FOREIGN KEY  (ID) REFERENCES SBI_USER (ID) ON DELETE CASCADE ;


ALTER TABLE SBI_USER_ATTRIBUTES ADD CONSTRAINT FK_SBI_USER_ATTRIBUTES_2 FOREIGN KEY  (ATTRIBUTE_ID, ORGANIZATION) REFERENCES SBI_ATTRIBUTE (ATTRIBUTE_ID, ORGANIZATION)  ON DELETE CASCADE;
...
ALTER TABLE SBI_UDP_VALUE ADD CONSTRAINT FK_SBI_UDP_VALUE_2 FOREIGN KEY  ( UDP_ID ) REFERENCES SBI_UDP ( UDP_ID ) ;
...
ALTER TABLE SBI_KPI_VALUE ADD CONSTRAINT  FK_SBI_KPI_VALUE_4  FOREIGN KEY    ( HIERARCHY_ID ) REFERENCES  SBI_ORG_UNIT_HIERARCHIES  ( ID )   ;
...
ALTER TABLE SBI_GOAL_HIERARCHY ADD CONSTRAINT FK_SBI_GOAL_HIERARCHY_GOAL  FOREIGN KEY  (GOAL_ID) REFERENCES SBI_GOAL (GOAL_ID)  ;
ALTER TABLE SBI_GOAL_HIERARCHY ADD CONSTRAINT FK_SBI_GOAL_HIERARCHY_PARENT  FOREIGN KEY  (PARENT_ID) REFERENCES SBI_GOAL_HIERARCHY (GOAL_HIERARCHY_ID) ;
...
-- thanks to gorotma for the note on "RESTICT" 
