...
CREATE TABLE SBI_EXT_ROLES (
       ...
       SAVE_SUBOBJECTS				BIT DEFAULT 1,
       SEE_SUBOBJECTS				BIT DEFAULT 1,
       SEE_VIEWPOINTS				BIT DEFAULT 1,
       SEE_SNAPSHOTS				BIT DEFAULT 1,
       SEE_NOTES					BIT DEFAULT 1,
       SEND_MAIL					BIT DEFAULT 1,
       SAVE_INTO_FOLDER				BIT DEFAULT 1,
       SAVE_REMEMBER_ME				BIT DEFAULT 1,
       SEE_METADATA 				BIT DEFAULT 1,
       SAVE_METADATA 				BIT DEFAULT 1,
       BUILD_QBE_QUERY 				BIT DEFAULT 1,
       DO_MASSIVE_EXPORT 		    BIT DEFAULT 1,
       EDIT_WORKSHEET 				BIT DEFAULT 1,
       MANAGE_USERS                 BIT DEFAULT 0,
       SEE_DOCUMENT_BROWSER 		BIT DEFAULT 1,
       SEE_FAVOURITES 				BIT DEFAULT 1,
       SEE_SUBSCRIPTIONS 			BIT DEFAULT 1,
       SEE_MY_DATA 					BIT DEFAULT 1,
       SEE_TODO_LIST 				BIT DEFAULT 1,
       CREATE_DOCUMENTS 			BIT DEFAULT 1,
       USER_IN              		VARCHAR(100) NOT NULL,
       USER_UP             			VARCHAR(100),
       USER_DE              		VARCHAR(100),
       TIME_IN              		DATETIME NOT NULL,
...
-- Modified
ALTER TABLE SBI_ORG_UNIT_NODES ADD CONSTRAINT FK_SBI_ORG_UNIT_NODES_3 FOREIGN KEY  ( PARENT_NODE_ID ) REFERENCES SBI_ORG_UNIT_NODES ( NODE_ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;
