...
CREATE TABLE SBI_PARUSE (
       ...
       MAXIMIZER_ENABLED    BIT default 0,
...
CREATE TABLE SBI_AUDIT ( 
        ...
        EXECUTION_START     datetime NULL DEFAULT NULL,
        EXECUTION_END       datetime NULL DEFAULT NULL,
...
CREATE TABLE SBI_DATA_SOURCE (
        ...
        MULTI_SCHEMA         BIT  NOT NULL DEFAULT '0',
...
CREATE TABLE  SBI_KPI_INSTANCE  (
       ...
       WEIGHT               NUMERIC,
       TARGET               NUMERIC,
       BEGIN_DT             DATE NOT NULL DEFAULT getdate(),
       USER_IN              VARCHAR(100) NOT NULL,
       USER_UP              VARCHAR(100),
       USER_DE              VARCHAR(100),
       TIME_IN              datetime NOT NULL,
...
CREATE TABLE  SBI_KPI_INSTANCE_HISTORY  (
       ...
       TARGET               NUMERIC,
       BEGIN_DT             DATE NOT NULL DEFAULT getdate(),
       END_DT               DATE NOT NULL DEFAULT getdate(),
       USER_IN              VARCHAR(100) NOT NULL,
       USER_UP              VARCHAR(100),
       USER_DE              VARCHAR(100),
       TIME_IN              datetime NOT NULL,
...
CREATE TABLE  SBI_ALARM_EVENT  (
     ...
     ALARM_ID  INTEGER NOT NULL,
     EVENT_TS  DATE NOT NULL DEFAULT getdate() ,
     ACTIVE  CHAR(1) ,
...
CREATE TABLE SBI_CONFIG (
 ...
 CREATE TABLE SBI_USER (
    ...
    ID INTEGER NOT NULL,
    DT_PWD_BEGIN datetime NULL DEFAULT NULL,
    DT_PWD_END datetime NULL DEFAULT NULL,
    FLG_PWD_BLOCKED BIT,
    DT_LAST_ACCESS datetime NULL DEFAULT NULL,
...
CREATE TABLE SBI_ORGANIZATION_ENGINE (
  ...
  CREATION_DATE datetime NOT NULL DEFAULT getdate() ,
  LAST_CHANGE_DATE datetime NULL DEFAULT NULL,
  USER_IN VARCHAR(100) NOT NULL,
  USER_UP VARCHAR(100) DEFAULT NULL,
  USER_DE VARCHAR(100) DEFAULT NULL,
...
ALTER TABLE SBI_CHECKS ADD CONSTRAINT FK_SBI_CHECKS_1 FOREIGN KEY  ( VALUE_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_EXT_ROLES ADD CONSTRAINT FK_SBI_EXT_ROLES_1 FOREIGN KEY  ( ROLE_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_FUNC_ROLE ADD CONSTRAINT FK_SBI_FUNC_ROLE_3 FOREIGN KEY  ( FUNCT_ID ) REFERENCES SBI_FUNCTIONS ( FUNCT_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_FUNC_ROLE ADD CONSTRAINT FK_SBI_FUNC_ROLE_1 FOREIGN KEY  ( ROLE_ID ) REFERENCES SBI_EXT_ROLES ( EXT_ROLE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_FUNC_ROLE ADD CONSTRAINT FK_SBI_FUNC_ROLE_2 FOREIGN KEY  ( STATE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_FUNCTIONS ADD CONSTRAINT FK_SBI_FUNCTIONS_1 FOREIGN KEY  ( FUNCT_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_FUNCTIONS ADD CONSTRAINT FK_SBI_FUNCTIONS_2 FOREIGN KEY  ( PARENT_FUNCT_ID ) REFERENCES SBI_FUNCTIONS ( FUNCT_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_LOV ADD CONSTRAINT FK_SBI_LOV_1 FOREIGN KEY  ( INPUT_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_FUNC ADD CONSTRAINT FK_SBI_OBJ_FUNC_2 FOREIGN KEY  ( BIOBJ_ID ) REFERENCES SBI_OBJECTS ( BIOBJ_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_FUNC ADD CONSTRAINT FK_SBI_OBJ_FUNC_1 FOREIGN KEY  ( FUNCT_ID ) REFERENCES SBI_FUNCTIONS ( FUNCT_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_PAR ADD CONSTRAINT FK_SBI_OBJ_PAR_1 FOREIGN KEY  ( BIOBJ_ID ) REFERENCES SBI_OBJECTS ( BIOBJ_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_PAR ADD CONSTRAINT FK_SBI_OBJ_PAR_2 FOREIGN KEY  ( PAR_ID ) REFERENCES SBI_PARAMETERS ( PAR_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_STATE ADD CONSTRAINT FK_SBI_OBJ_STATE_1 FOREIGN KEY  ( BIOBJ_ID ) REFERENCES SBI_OBJECTS ( BIOBJ_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_STATE ADD CONSTRAINT FK_SBI_OBJ_STATE_2 FOREIGN KEY  ( STATE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT FK_SBI_OBJECTS_2 FOREIGN KEY  ( STATE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT FK_SBI_OBJECTS_3 FOREIGN KEY  ( BIOBJ_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
--ALTER TABLE SBI_OBJECTS ADD CONSTRAINT FK_SBI_OBJECTS_5 FOREIGN KEY  ( ENGINE_ID ) REFERENCES SBI_ENGINES ( ENGINE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT FK_SBI_OBJECTS_4 FOREIGN KEY  ( EXEC_MODE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT FK_SBI_OBJECTS_1 FOREIGN KEY  ( STATE_CONS_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
--ALTER TABLE SBI_OBJECTS ADD CONSTRAINT FK_SBI_OBJECTS_6 FOREIGN KEY  ( DATA_SOURCE_ID ) REFERENCES SBI_DATA_SOURCE ( DS_ID ) ON DELETE NO ACTION;
...
ALTER TABLE SBI_PARAMETERS ADD CONSTRAINT FK_SBI_PARAMETERS_1 FOREIGN KEY  ( PAR_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_PARUSE ADD CONSTRAINT FK_SBI_PARUSE_1 FOREIGN KEY  ( PAR_ID ) REFERENCES SBI_PARAMETERS ( PAR_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_PARUSE ADD CONSTRAINT FK_SBI_PARUSE_2 FOREIGN KEY  ( LOV_ID ) REFERENCES SBI_LOV ( LOV_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_PARUSE ADD CONSTRAINT FK_SBI_PARUSE_3 FOREIGN KEY  ( DEFAULT_LOV_ID ) REFERENCES SBI_LOV ( LOV_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_PARUSE_CK ADD CONSTRAINT FK_SBI_PARUSE_CK_1 FOREIGN KEY  ( USE_ID ) REFERENCES SBI_PARUSE ( USE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_PARUSE_CK ADD CONSTRAINT FK_SBI_PARUSE_CK_2 FOREIGN KEY  ( CHECK_ID ) REFERENCES SBI_CHECKS ( CHECK_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_PARUSE_DET ADD CONSTRAINT FK_SBI_PARUSE_DET_1 FOREIGN KEY  ( USE_ID ) REFERENCES SBI_PARUSE ( USE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_PARUSE_DET ADD CONSTRAINT FK_SBI_PARUSE_DET_2 FOREIGN KEY  ( EXT_ROLE_ID ) REFERENCES SBI_EXT_ROLES ( EXT_ROLE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_PARUSE ADD CONSTRAINT FK_SBI_OBJ_PARUSE_1 FOREIGN KEY  ( OBJ_PAR_ID ) REFERENCES SBI_OBJ_PAR ( OBJ_PAR_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_PARUSE ADD CONSTRAINT FK_SBI_OBJ_PARUSE_2 FOREIGN KEY  ( USE_ID ) REFERENCES SBI_PARUSE ( USE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_PARUSE ADD CONSTRAINT FK_SBI_OBJ_PARUSE_3 FOREIGN KEY  ( OBJ_PAR_FATHER_ID ) REFERENCES SBI_OBJ_PAR ( OBJ_PAR_ID ) ON DELETE NO ACTION;
...
-- DEFINITION
ALTER TABLE  SBI_THRESHOLD  ADD  CONSTRAINT FK_SBI_THRESHOLD_1 FOREIGN KEY ( THRESHOLD_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_MEASURE_UNIT  ADD  CONSTRAINT FK_SBI_MEASURE_UNIT_1 FOREIGN KEY ( SCALE_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_THRESHOLD_VALUE  ADD  CONSTRAINT FK_SBI_THRESHOLD_VALUE_1 FOREIGN KEY ( SEVERITY_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
...
ALTER TABLE  SBI_KPI_ROLE  ADD  CONSTRAINT FK_SBI_KPI_ROLE_1 FOREIGN KEY ( EXT_ROLE_ID ) REFERENCES  SBI_EXT_ROLES  ( EXT_ROLE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_ROLE  ADD CONSTRAINT FK_SBI_KPI_ROLE_2 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI  ADD  CONSTRAINT FK_SBI_KPI_1 FOREIGN KEY ( ID_MEASURE_UNIT ) REFERENCES  SBI_MEASURE_UNIT  ( ID_MEASURE_UNIT ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
...
ALTER TABLE  SBI_KPI  ADD  CONSTRAINT FK_SBI_KPI_3 FOREIGN KEY ( ID_KPI_PARENT ) REFERENCES  SBI_KPI  ( KPI_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
...
ALTER TABLE  SBI_KPI_DOCUMENTS  ADD  CONSTRAINT FK_SBI_KPI_DOCUMENTS_2 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL  ADD  CONSTRAINT FK_SBI_KPI_MODEL_1 FOREIGN KEY ( KPI_PARENT_MODEL_ID ) REFERENCES  SBI_KPI_MODEL  ( KPI_MODEL_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL  ADD CONSTRAINT FK_KPI_MODEL_2 FOREIGN KEY ( KPI_MODEL_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL  ADD  CONSTRAINT FK_SBI_KPI_MODEL_3 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;

-- INSTANCE
ALTER TABLE  SBI_KPI_INSTANCE  ADD  CONSTRAINT FK_SBI_KPI_INSTANCE_1 FOREIGN KEY ( KPI_ID ) REFERENCES  SBI_KPI  ( KPI_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INSTANCE  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_2 FOREIGN KEY ( CHART_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INSTANCE  ADD  CONSTRAINT FK_SBI_KPI_INSTANCE_3 FOREIGN KEY ( ID_MEASURE_UNIT ) REFERENCES  SBI_MEASURE_UNIT  ( ID_MEASURE_UNIT ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INSTANCE  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_4 FOREIGN KEY ( THRESHOLD_ID ) REFERENCES  SBI_THRESHOLD  ( THRESHOLD_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_1 FOREIGN KEY ( ID_MEASURE_UNIT ) REFERENCES  SBI_MEASURE_UNIT  ( ID_MEASURE_UNIT ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_2 FOREIGN KEY ( THRESHOLD_ID ) REFERENCES  SBI_THRESHOLD  ( THRESHOLD_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_3 FOREIGN KEY ( CHART_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INSTANCE_HISTORY  ADD  CONSTRAINT FK_SBI_KPI_INSTANCE_HISTORY_4 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL_INST  ADD CONSTRAINT FK_SBI_KPI_MODEL_INST_1 FOREIGN KEY ( KPI_MODEL_INST_PARENT ) REFERENCES  SBI_KPI_MODEL_INST  ( KPI_MODEL_INST ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL_INST  ADD  CONSTRAINT FK_SBI_KPI_MODEL_INST_2 FOREIGN KEY ( KPI_MODEL_ID ) REFERENCES  SBI_KPI_MODEL  ( KPI_MODEL_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL_INST  ADD CONSTRAINT FK_SBI_KPI_MODEL_INST_3 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL_RESOURCES  ADD  CONSTRAINT FK_SBI_KPI_MODEL_RESOURCES_1 FOREIGN KEY ( KPI_MODEL_INST ) REFERENCES  SBI_KPI_MODEL_INST  ( KPI_MODEL_INST ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_MODEL_RESOURCES  ADD  CONSTRAINT FK_SBI_KPI_MODEL_RESOURCES_2 FOREIGN KEY ( RESOURCE_ID ) REFERENCES  SBI_RESOURCES  ( RESOURCE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_RESOURCES  ADD  CONSTRAINT FK_SBI_RESOURCES_1 FOREIGN KEY ( RESOURCE_TYPE_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_VALUE  ADD  CONSTRAINT FK_SBI_KPI_VALUE_1 FOREIGN KEY ( RESOURCE_ID ) REFERENCES  SBI_RESOURCES  ( RESOURCE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_VALUE  ADD  CONSTRAINT FK_SBI_KPI_VALUE_2 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI_INST_PERIOD  ADD  CONSTRAINT FK_SBI_KPI_INST_PERIOD_1 FOREIGN KEY ( PERIODICITY_ID ) REFERENCES  SBI_KPI_PERIODICITY  ( ID_KPI_PERIODICITY ) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE  SBI_KPI_INST_PERIOD  ADD  CONSTRAINT FK_SBI_KPI_INST_PERIOD_2 FOREIGN KEY  ( KPI_INSTANCE_ID ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE ) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ALARM
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_1 FOREIGN KEY ( MODALITY_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_2 FOREIGN KEY ( DOCUMENT_ID ) REFERENCES  SBI_OBJECTS  ( BIOBJ_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_3 FOREIGN KEY ( ID_KPI_INSTANCE ) REFERENCES  SBI_KPI_INSTANCE  ( ID_KPI_INSTANCE ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_ALARM  ADD CONSTRAINT FK_SBI_ALARM_4 FOREIGN KEY ( ID_THRESHOLD_VALUE ) REFERENCES  SBI_THRESHOLD_VALUE  ( ID_THRESHOLD_VALUE ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
...
ALTER TABLE  SBI_ALARM_DISTRIBUTION  ADD CONSTRAINT FK_SBI_ALARM_DISTRIBUTION_1 FOREIGN KEY ( ALARM_ID ) REFERENCES  SBI_ALARM  ( ALARM_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_ALARM_DISTRIBUTION  ADD CONSTRAINT FK_SBI_ALARM_DISTRIBUTION_2 FOREIGN KEY ( ALARM_CONTACT_ID ) REFERENCES  SBI_ALARM_CONTACT  ( ALARM_CONTACT_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;

ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_4 FOREIGN KEY ( KPI_TYPE ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_5 FOREIGN KEY ( METRIC_SCALE_TYPE ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_KPI  ADD CONSTRAINT FK_SBI_KPI_6 FOREIGN KEY ( MEASURE_TYPE ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;

ALTER TABLE  SBI_EXPORTERS  ADD CONSTRAINT FK_SBI_EXPORTERS_1 FOREIGN KEY ( ENGINE_ID ) REFERENCES  SBI_ENGINES  ( ENGINE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE  SBI_EXPORTERS  ADD CONSTRAINT FK_SBI_EXPORTERS_2 FOREIGN KEY ( DOMAIN_ID ) REFERENCES  SBI_DOMAINS  ( VALUE_ID ) ON DELETE  NO ACTION ON UPDATE  NO ACTION;

ALTER TABLE SBI_CONFIG ADD CONSTRAINT FK_SBI_CONFIG_1 FOREIGN KEY  ( VALUE_TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_USER_ATTRIBUTES ADD CONSTRAINT FK_SBI_USER_ATTRIBUTES_1 FOREIGN KEY  (ID) REFERENCES SBI_USER (ID) ON DELETE CASCADE ON UPDATE  NO ACTION;
ALTER TABLE SBI_EXT_USER_ROLES ADD CONSTRAINT FK_SBI_EXT_USER_ROLES_1 FOREIGN KEY  (ID) REFERENCES SBI_USER (ID) ON DELETE CASCADE ON UPDATE  NO ACTION;
ALTER TABLE SBI_USER_ATTRIBUTES ADD CONSTRAINT FK_SBI_USER_ATTRIBUTES_2 FOREIGN KEY  (ATTRIBUTE_ID) REFERENCES SBI_ATTRIBUTE (ATTRIBUTE_ID) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
ALTER TABLE SBI_EXT_USER_ROLES ADD CONSTRAINT FK_SBI_EXT_USER_ROLES_2 FOREIGN KEY  (EXT_ROLE_ID) REFERENCES SBI_EXT_ROLES (EXT_ROLE_ID) ON DELETE  NO ACTION ON UPDATE  NO ACTION;
 
ALTER TABLE SBI_UDP ADD CONSTRAINT FK_SBI_SBI_UDP_1 FOREIGN KEY  ( TYPE_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_UDP ADD CONSTRAINT FK_SBI_SBI_UDP_2 FOREIGN KEY  ( FAMILY_ID ) REFERENCES SBI_DOMAINS ( VALUE_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_UDP_VALUE ADD CONSTRAINT FK_SBI_UDP_VALUE_2 FOREIGN KEY  ( UDP_ID ) REFERENCES SBI_UDP ( UDP_ID ) ON DELETE NO ACTION;

ALTER TABLE SBI_KPI_REL ADD CONSTRAINT FK_SBI_KPI_REL_3 FOREIGN KEY  ( KPI_FATHER_ID ) REFERENCES SBI_KPI ( KPI_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_KPI_REL ADD CONSTRAINT FK_SBI_KPI_REL_4 FOREIGN KEY  ( KPI_CHILD_ID ) REFERENCES SBI_KPI ( KPI_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_KPI_ERROR ADD CONSTRAINT FK_SBI_KPI_ERROR_MODEL_1 FOREIGN KEY  ( KPI_MODEL_INST_ID ) REFERENCES SBI_KPI_MODEL_INST ( KPI_MODEL_INST ) ON DELETE NO ACTION;
...
ALTER TABLE SBI_ORG_UNIT_NODES ADD CONSTRAINT FK_SBI_ORG_UNIT_NODES_3 FOREIGN KEY  ( PARENT_NODE_ID ) REFERENCES SBI_ORG_UNIT_NODES ( NODE_ID ) ON DELETE NO ACTION;
...
ALTER TABLE SBI_ORG_UNIT_GRANT_NODES ADD CONSTRAINT FK_SBI_ORG_UNIT_GRANT_NODES_3 FOREIGN KEY  ( GRANT_ID ) REFERENCES SBI_ORG_UNIT_GRANT ( ID ) ON DELETE NO ACTION;

ALTER TABLE SBI_KPI_VALUE ADD CONSTRAINT  FK_SBI_KPI_VALUE_4  FOREIGN KEY    ( HIERARCHY_ID ) REFERENCES  SBI_ORG_UNIT_HIERARCHIES  ( ID ) ON DELETE NO ACTION  ON UPDATE NO ACTION;
    
ALTER TABLE SBI_GOAL ADD CONSTRAINT FK_GRANT_ID_GRANT  FOREIGN KEY  (GRANT_ID) REFERENCES SBI_ORG_UNIT_GRANT (ID) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE SBI_GOAL_HIERARCHY ADD CONSTRAINT FK_SBI_GOAL_HIERARCHY_GOAL  FOREIGN KEY  (GOAL_ID) REFERENCES SBI_GOAL (GOAL_ID) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE SBI_GOAL_HIERARCHY ADD CONSTRAINT FK_SBI_GOAL_HIERARCHY_PARENT  FOREIGN KEY  (PARENT_ID) REFERENCES SBI_GOAL_HIERARCHY (GOAL_HIERARCHY_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE SBI_GOAL_KPI ADD CONSTRAINT FK_SBI_GOAL_KPI_GOAL  FOREIGN KEY  (GOAL_HIERARCHY_ID) REFERENCES SBI_GOAL_HIERARCHY (GOAL_HIERARCHY_ID)  ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE SBI_GOAL_KPI ADD CONSTRAINT FK_SBI_GOAL_KPI_KPI  FOREIGN KEY  (KPI_INSTANCE_ID) REFERENCES SBI_KPI_MODEL_INST (KPI_MODEL_INST) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE SBI_OBJ_PARVIEW ADD CONSTRAINT FK_SBI_OBJ_PARVIEW_1 FOREIGN KEY ( OBJ_PAR_ID ) REFERENCES SBI_OBJ_PAR ( OBJ_PAR_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_OBJ_PARVIEW ADD CONSTRAINT FK_SBI_OBJ_PARVIEW_2 FOREIGN KEY ( OBJ_PAR_FATHER_ID ) REFERENCES SBI_OBJ_PAR ( OBJ_PAR_ID ) ON DELETE NO ACTION;
ALTER TABLE SBI_I18N_MESSAGES ADD CONSTRAINT FK_SBI_I18N_MESSAGES FOREIGN KEY (LANGUAGE_CD) REFERENCES SBI_DOMAINS(VALUE_ID) ON DELETE NO ACTION;
...
-- Date Range
ALTER TABLE SBI_PARUSE ADD COLUMN OPTIONS VARCHAR(4000) NULL DEFAULT NULL AFTER ORGANIZATION;