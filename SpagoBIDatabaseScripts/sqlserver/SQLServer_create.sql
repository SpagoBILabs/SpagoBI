...
CREATE TABLE SBI_DATA_SOURCE (
        ...
        META_VERSION         VARCHAR(100),
        ORGANIZATION         VARCHAR(20),   
        CONSTRAINT AK1SBI_DATA_SOURCE UNIQUE  (LABEL),
...
CREATE TABLE SBI_DIST_LIST (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
       CONSTRAINT AK1SBI_SBI_DIST_LIST UNIQUE  (DL_ID), 
...
CREATE TABLE SBI_DATA_SET (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),  	
       CONSTRAINT AK1SBI_DATA_SET UNIQUE  (LABEL),
...
CREATE TABLE SBI_ATTRIBUTE (
	...
	ATTRIBUTE_ID INTEGER NOT NULL,
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),     
 	CONSTRAINT PK_SBI_ATTRIBUTE PRIMARY KEY CLUSTERED(ATTRIBUTE_ID)
) ON [PRIMARY]
...
CREATE TABLE SBI_I18N_MESSAGES (
  ...
  LABEL VARCHAR(200) NOT NULL,
  MESSAGE TEXT,
  CONSTRAINT PK_I18N_MESSAGES PRIMARY KEY CLUSTERED(LANGUAGE_CD, LABEL)
) ON [PRIMARY]
