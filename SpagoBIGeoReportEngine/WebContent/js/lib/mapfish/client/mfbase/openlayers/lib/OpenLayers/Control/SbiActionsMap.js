 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.SbiActionsMap = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * Constructor: OpenLayers.Control.SbiActionsMap
...
//    	alert('*** SbiActionsMap !! ***');    	
        ...
        this.position = new OpenLayers.Pixel(OpenLayers.Control.SbiActionsMap.X,
        									 OpenLayers.Control.SbiActionsMap.Y);
