...
Sbi.geo.Toolbar = function(config) {
	...
	// constructor
	Sbi.geo.Toolbar.superclass.constructor.call(this, c);

};

/**
 * @class Sbi.geo.Toolbar
 * @extends mapfish.widgets.toolbar.Toolbar
 * 
 * ...
 */
Ext.extend(Sbi.geo.Toolbar, mapfish.widgets.toolbar.Toolbar, {
	...
	, showImportWMSLayerWin: function() {
		if(this.importWMSLayerWin === null) {
			var importWMSLayerForm = new Sbi.geo.ImportWMSLayerForm();
