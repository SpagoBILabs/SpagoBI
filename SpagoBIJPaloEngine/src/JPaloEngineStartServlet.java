...
public class JPaloEngineStartServlet extends AbstractEngineStartServlet {
    ...
    public void doService( EngineStartServletIOManager servletIOManager ) throws SpagoBIEngineException {
		...
		try {		
			...
			ContentServiceProxy contentProxy = new ContentServiceProxy(profile.getUserUniqueIdentifier()+"", session);
			...
			if((isNewDoc != null && isNewDoc.equals("true")) && 
				...
				HashMap requestParameters = ParametersDecoder.getDecodedRequestParameters(servletIOManager.getRequest());
				Content templateContent=contentProxy.readTemplate( documentId,requestParameters);
			...
			if(isSpagoBIDev != null && isSpagoBIDev.equals("true")){
				...
				if(template == null 
					...
					logger.error("The incomplete url is: "+jpaloUrl);
