...
<%-- uses hsql --%>
<%--jp:mondrianQuery id="query01" jdbcDriver="org.hsqldb.jdbcDriver" jdbcUrl="jdbc:hsqldb:hsql://localhost:9002/foodmart" catalogUri="/WEB-INF/queries/FoodMart.xml"--%>
...
<%--<jp:mondrianQuery id="query01" jdbcDriver="org.hsqldb.jdbcDriver" jdbcUrl="jdbc:hsqldb:hsql://localhost:9002/foodmart" catalogUri="/WEB-INF/queries/FoodMart.xml">--%> 
<jp:mondrianQuery id="query01" dataSource="jdbc/foodmart" catalogUri="/WEB-INF/queries/FoodMart.xml">
select
