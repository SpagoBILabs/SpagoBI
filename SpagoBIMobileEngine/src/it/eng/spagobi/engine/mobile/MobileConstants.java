...
public class MobileConstants {
	...
	public static final String DOCUMENT_TYPE_MOBILE_REPORT = "MOBILE_REPORT";
	...
	public static final String DOCUMENT_LABEL_ATTR = "label";
	public static final String DOCUMENT_WIDTH_ATTR = "width";
	public static final String DOCUMENT_HEIGHT_ATTR = "height";
	public static final String DOCUMENTS_WIDTH_ATTR = "width";
