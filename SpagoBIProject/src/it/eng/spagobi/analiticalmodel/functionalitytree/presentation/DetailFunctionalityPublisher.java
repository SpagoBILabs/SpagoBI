 ...
 * @author sulis
 */
public class DetailFunctionalityPublisher implements PublisherDispatcherIFace {
	...
	public String getPublisherName(RequestContainer requestContainer, ResponseContainer responseContainer) {
        ...
        if(loop != null) {
        	return new String("detailFunctionalityLoop");
		} else {
			return new String("detailFunctionality");
		}
