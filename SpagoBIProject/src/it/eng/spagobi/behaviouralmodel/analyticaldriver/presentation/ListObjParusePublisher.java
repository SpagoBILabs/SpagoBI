 ...
 * execution of the <code>ListObjParuseModule</code> class, the publisher is able to call the error 
 * page with the error message caught before and put into the error handler. 
 * 
 * @author zerbetto
 */
public class ListObjParusePublisher implements PublisherDispatcherIFace{
