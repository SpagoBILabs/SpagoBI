...
/**
 * Loads the parameter use modes list
 * 
 * @author sulis
 */
public class ListParameterUsesModule extends AbstractBasicListModule {
	
	public static final String MODULE_PAGE = "ListParameterUsesPage";
