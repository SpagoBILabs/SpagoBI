...
/**
 * Loads the value constraints list
 * 
 * @author sulis
 */
public class ListChecksModule extends AbstractBasicListModule {
	public static final String MODULE_PAGE = "ListModalitiesChecksPage";
	
	/**
	 * Class Constructor.
	 */
	public ListChecksModule() {
		super();
	} 
