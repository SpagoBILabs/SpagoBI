...
DELETE FROM SBI_FUNCTIONS WHERE ORGANIZATION = ? ORDER BY FUNCT_ID DESC;
...
DELETE FROM SBI_USER_FUNC WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_KPI_MODEL_RESOURCES WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_ALARM_DISTRIBUTION WHERE ALARM_CONTACT_ID = (select t.ALARM_CONTACT_ID from SBI_ALARM_CONTACT t WHERE t.ORGANIZATION = ?);
...
DELETE FROM SBI_FUNCTIONALITIES_ROLES WHERE ORGANIZATION = ?;
DELETE FROM SBI_FUNCTIONALITIES WHERE ORGANIZATION = ?;
