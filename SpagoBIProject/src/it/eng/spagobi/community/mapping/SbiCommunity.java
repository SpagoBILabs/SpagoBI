 ...
 */
public class SbiCommunity  extends SbiHibernateModel implements java.io.Serializable {
	...
	public SbiCommunity(String name, int owner, Date creationDate,
	...
	public SbiCommunity(String name, String description, int owner,
