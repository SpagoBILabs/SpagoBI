/**
 * AuditServiceSoapBindingSkeleton.java
 *
...
public class AuditServiceSoapBindingSkeleton implements it.eng.spagobi.services.audit.stub.AuditService, org.apache.axis.wsdl.Skeleton {
    private it.eng.spagobi.services.audit.stub.AuditService impl;
    ...
    */
    ...
    static {
        ...
        _oper.setElementQName(new javax.xml.namespace.QName("urn:spagobiaudit", "log"));
        _oper.setSoapAction("");
    ...
    public AuditServiceSoapBindingSkeleton() {
        this.impl = new it.eng.spagobi.services.audit.stub.AuditServiceSoapBindingImpl();
    }
