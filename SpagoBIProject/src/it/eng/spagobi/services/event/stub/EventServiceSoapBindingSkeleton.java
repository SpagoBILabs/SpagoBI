/**
 * EventServiceSoapBindingSkeleton.java
 *
...
public class EventServiceSoapBindingSkeleton implements it.eng.spagobi.services.event.stub.EventService, org.apache.axis.wsdl.Skeleton {
    private it.eng.spagobi.services.event.stub.EventService impl;
    ...
    */
    ...
    static {
        ...
        _oper = new org.apache.axis.description.OperationDesc("fireEvent", _params, new javax.xml.namespace.QName("", "fireEventReturn"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"));
        _oper.setElementQName(new javax.xml.namespace.QName("urn:spagobievent", "fireEvent"));
        _oper.setSoapAction("");
        _myOperationsList.add(_oper);
        if (_myOperations.get("fireEvent") == null) {
            _myOperations.put("fireEvent", new java.util.ArrayList());
        }
        ((java.util.List)_myOperations.get("fireEvent")).add(_oper);
    }

    public EventServiceSoapBindingSkeleton() {
        this.impl = new it.eng.spagobi.services.event.stub.EventServiceSoapBindingImpl();
    }
    ...
    {
        java.lang.String ret = impl.fireEvent(in0, in1, in2, in3, in4, in5);
        return ret;
    }
