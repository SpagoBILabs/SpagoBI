 ...
 */
public class ListDistributionListUserPublisher implements PublisherDispatcherIFace{
	
	static private Logger logger = Logger.getLogger(ListDistributionListUserPublisher.class);
