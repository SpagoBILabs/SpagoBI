...
/**
 * Publishes the results of a detail request for a meta content into the correct 
 * jsp page according to what contained into request. If Any errors occurred during the 
 * execution of the <code>DetailObjMetadataModule</code> class, the publisher
 ...
 * 
 */
public class DetailObjMetadataPublisher implements PublisherDispatcherIFace {
	static private Logger logger = Logger.getLogger(DetailObjMetadataPublisher.class);
