...
/**
 * Loads the objects' metadata list
 */
public class ListObjMetadataModule extends AbstractBasicListModule {
	
	public static final String MODULE_PAGE = "ListObjMetadataPage";
