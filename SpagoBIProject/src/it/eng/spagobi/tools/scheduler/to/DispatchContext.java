...
public class DispatchContext implements Serializable {
	...
	/*
	 * True if the destination folder path properties is relative to the resource folder.
	 * If so the the dispatch path will be generated by the following code ...
	...
	public void setDestinationFolderRelativeToResourceFolder(
			boolean destinationFolderRelativeToResourceFolder) {
