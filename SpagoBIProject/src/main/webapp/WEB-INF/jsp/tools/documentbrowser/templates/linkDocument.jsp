...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="/SpagoBI/js/src/angular_1.4/tools/documentbrowser/linkDocument.js"></script>
		<link rel="stylesheet" type="text/css"	href="/SpagoBI/themes/commons/css/customStyle.css">
