...
Ext.define('Sbi.widgets.grid.DynamicFilteringToolbar2', {
	...
	getValue: function()
	{
		...
		// I changed this in order to get proper (expected) value for name of the column 
		// (e.g. "sales_city", not "column_2")
//		filterConfig.columnsFilter = ;
