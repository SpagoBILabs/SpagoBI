	...
	<tr class='header-row-portlet-section'>
		...
		<td class='header-button-column-portlet-section'>
			<a href='<%=backUrl%>'> 
      			...
      			title='<spagobi:message key = "sbi.kpi.grantsDefinition.buttons.back" bundle="<%=messageBunle%>" />' 
      			src='<%=urlBuilder.getResourceLinkByTheme(request, "/img/back.png", currTheme)%>' 
      			alt='<spagobi:message key = "sbi.kpi.grantsDefinition.buttons.back" bundle="<%=messageBunle%>" />' />
			</a>
		</td>
	</tr>
</table>
