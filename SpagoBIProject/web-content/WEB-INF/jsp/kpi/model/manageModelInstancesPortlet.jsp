...
String url = GeneralUtilities.getSpagoBIProfileBaseUrl(userUniqueIdentifier)+  "&ACTION_NAME=MANAGE_MODEL_INSTANCES_ACTION";
url += "&LANGUAGE=" + locale.getLanguage();
url += "&COUNTRY=" + locale.getCountry();
%>
	<iframe 
		id='modelInstancesIframe'
		name='modelInstancesIframe'
		src='<%= url %>'
		frameBorder = 0
		width=100%
