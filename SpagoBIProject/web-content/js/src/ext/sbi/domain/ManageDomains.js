...
Sbi.domain.ManageDomains = function(config) {
	...
	var paramsList = {MESSAGE_DET: "DOMAIN_LIST"};
	var paramsSave = {LIGHT_NAVIGATOR_DISABLED: 'TRUE',MESSAGE_DET: "DOMAIN_SAVE"};
	var paramsDel = {LIGHT_NAVIGATOR_DISABLED: 'TRUE',MESSAGE_DET: "DOMAIN_DELETE"};

	this.crudServices = {};
	
	this.crudServices['manageListService'] = Sbi.config.serviceRegistry.getServiceUrl({
		serviceName: 'DOMAIN_ACTION'
		, baseParams: paramsList
	});
	this.crudServices['saveItemService'] = Sbi.config.serviceRegistry.getServiceUrl({
		serviceName: 'DOMAIN_ACTION'
		, baseParams: paramsSave
	});
	this.crudServices['deleteItemService'] = Sbi.config.serviceRegistry.getServiceUrl({
		serviceName: 'DOMAIN_ACTION'
