...
Ext.extend(Sbi.engines.chart.HighchartsPanel, Sbi.engines.chart.GenericChartPanel, {
	...
	, createChart: function () {
		...
		if(this.chartConfig.chart.type == 'line' && this.chartConfig.plotOptions.area != undefined){
			this.chartConfig.series =[{
		         type: 'area',
		         name: 'USD to EUR',
		         pointInterval: 8640000,
		...
		}else if(this.chartConfig.chart.type == 'pie'){
			this.chartConfig.series =[{
		         type: 'pie',
		         name: 'Browser share',
		         data: [
		...
		}else if(this.chartConfig.chart.type == 'scatter'){
			this.chartConfig.series =[{
		         name: 'Female',
...
/*			delete this.chartConfig.xAxis;
			...
			this.chartConfig.xAxis.categories =["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];*/
			if(this.chartConfig.plotOptions.line != undefined){
				this.chartConfig.series = [{
			         name: 'Tokyo',
