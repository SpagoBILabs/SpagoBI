...
Sbi.engines.chart.LineChartPanel = function(config) {
	
	var defaultSettings = {
	};
/*
	if (Sbi.settings && Sbi.engines.chart.LineChartPanel) {
		defaultSettings = Ext.apply(defaultSettings, Sbi.settings.engines.chart.LineChartPanel);
	}
*/
	...
	Sbi.engines.chart.LineChartPanel.superclass.constructor.call(this, c);
...
Ext.extend(Sbi.engines.chart.LineChartPanel, Sbi.engines.chart.GenericChartPanel, {
