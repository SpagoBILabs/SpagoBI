...
Sbi.locale.ln['sbidomains.nm.user'] = 'Utente';
Sbi.locale.ln['sbidomains.nm.admin'] = 'Amministratore';
Sbi.locale.ln['sbidomains.nm.dev_role'] = 'Sviluppatore';
Sbi.locale.ln['sbidomains.nm.test_role'] = 'Utente di Test';
Sbi.locale.ln['sbidomains.nm.model_admin'] = 'Amministratore di modelli';
...
Sbi.locale.ln['sbi.kpis.interpretation'] = 'Interpretazione';
Sbi.locale.ln['sbi.kpis.algDescr'] = 'Descrizione Algoritmo';
Sbi.locale.ln['sbi.kpis.inputAttr'] = 'Attributo di input';
...
Sbi.locale.ln['sbi.kpi.validity'] = 'Validit\u00e0';
...
Sbi.locale.ln['sbi.thresholds.severity'] = 'Severit\u00e0';
...
Sbi.locale.ln['sbi.browser.document.label']  = 'etichetta';
...
Sbi.locale.ln['sbi.browser.document.favourites']  = 'Favoriti';
...
Sbi.locale.ln['sbi.execution.parametersselection.toolbar.save.scope.description']='Seleziona uno scope a scope...';
...
Sbi.locale.ln['sbi.execution.parametersselection.executionbutton.message'] = 'Esegui';
Sbi.locale.ln['sbi.execution.parametersselection.executionbutton.tooltip'] = 'Compila il form sottostante e clicca qui per eseguire il documento';
...
Sbi.locale.ln['sbi.execution.executionpage.toolbar.refreshlastwarning'] = 'La selezione dei parametri � cambiata: vuoi eseguire il documento con la selezione corrente o con quella precedente?';
...
Sbi.locale.ln['sbi.execution.viewpoints.name'] = 'nome';
...
Sbi.locale.ln['sbi.execution.viewpoints.scope'] = 'visibilit\u00e0';
...
Sbi.locale.ln['sbi.execution.snapshots.emptyText'] = '[Il documento non ha esecuzioni schedulate]';
Sbi.locale.ln['sbi.execution.snapshots.name'] = 'nome';
Sbi.locale.ln['sbi.execution.snapshots.description'] = 'descrizione';
Sbi.locale.ln['sbi.execution.snapshots.creationDate'] = 'data di creazione';
Sbi.locale.ln['sbi.execution.snapshots.deleteSelected'] = 'Elimina';
Sbi.locale.ln['sbi.execution.snapshots.deleteSelectedTooltip'] = 'Elimina le esecuzioni schedulate selezionate';
Sbi.locale.ln['sbi.execution.snapshots.noSnapshotsSelected'] = 'Nessuna esecuzione schedulata selezionata';

Sbi.locale.ln['sbi.execution.subobjects.title'] = 'Viste customizzate';
Sbi.locale.ln['sbi.execution.subobjects.emptyText'] = '[Il documento non ha viste customizzate]';
...
Sbi.locale.ln['sbi.attributes.error'] = 'Errore';
...
Sbi.locale.ln['sbi.roles.saveMeta'] = 'Salva i Metadati';
Sbi.locale.ln['sbi.roles.saveRemember'] = 'Salva i Remember Me';
Sbi.locale.ln['sbi.roles.saveSubobj'] = 'Salva Viste Customizzate';
Sbi.locale.ln['sbi.roles.see'] = 'Vede';
Sbi.locale.ln['sbi.roles.seeMeta'] = 'Vede i Metadati';
Sbi.locale.ln['sbi.roles.seeNotes'] = 'Vede le Note';
Sbi.locale.ln['sbi.roles.seeSnapshot'] = 'Vede gli Snapshots';
Sbi.locale.ln['sbi.roles.seeSubobj'] = 'Vede Viste Customizzate';
Sbi.locale.ln['sbi.roles.seeViewpoints'] = 'Vede Parametri Salvati';
Sbi.locale.ln['sbi.roles.sendMail'] = 'Invio Mail';
...
Sbi.locale.ln['sbi.roles.manage'] = 'Gestire';
Sbi.locale.ln['sbi.roles.manageUsers'] = 'Utenti';
...
Sbi.locale.ln['sbi.roles.headerRoleType'] = 'Tipo di Ruolo';
Sbi.locale.ln['sbi.roles.detail'] = 'Dettaglio';
Sbi.locale.ln['sbi.roles.details'] = 'Dettagli';
Sbi.locale.ln['sbi.roles.authorizations'] = 'Autorizzazioni';
Sbi.locale.ln['sbi.roles.alfanumericString'] = 'Richiesta stringa alfanumerica (\x2F incluso)';
Sbi.locale.ln['sbi.roles.alfanumericString2'] = 'Richiesta stringa alfanumerica';
...
Sbi.locale.ln['sbi.roles.edit'] = 'Editare';
Sbi.locale.ln['sbi.roles.worksheet'] = 'Worksheet';
Sbi.locale.ln['sbi.roles.businessModels'] = 'Business Models';
Sbi.locale.ln['sbi.roles.businessModels.categories'] = 'Categorie Business Models';
...
Sbi.locale.ln['sbi.roles.viewSocialAnalysis'] = 'Vede analisi sui social network';
Sbi.locale.ln['sbi.roles.hierarchiesManagement'] = 'Editor delle gerarchie';
...
//KPI ALARMS
Sbi.locale.ln['sbi.alarmcontact.contactsManagement'] = 'Gestione dei Contatti';
Sbi.locale.ln['sbi.alarmcontact.contactsList'] = 'Lista Contatti';
Sbi.locale.ln['sbi.alarmcontact.name'] = 'Nome';
Sbi.locale.ln['sbi.alarmcontact.email'] = 'E-mail';
Sbi.locale.ln['sbi.alarmcontact.mobile'] = 'Cellulare';
Sbi.locale.ln['sbi.alarmcontact.resources'] = 'Risorse';
Sbi.locale.ln['sbi.alarmcontact.save'] = 'Salva';
Sbi.locale.ln['sbi.alarmcontact.add'] = 'Aggiungi';
Sbi.locale.ln['sbi.alarmcontact.detail'] = 'Dettaglio';
Sbi.locale.ln['sbi.alarmcontact.validString'] = 'Richiesta stringa alfanumerica (\x2F - incluso)';
Sbi.locale.ln['sbi.alarmcontact.validEmailString'] = 'Richiesta email';
Sbi.locale.ln['sbi.alarmcontact.validMobileString'] = 'Richiesta stringa di sole cifre';
Sbi.locale.ln['sbi.alarmcontact.error'] = 'Errore';
...
Sbi.locale.ln['sbi.execution.notes.modificationDate'] = 'Data ultima modifica ';
Sbi.locale.ln['sbi.execution.notes.notes'] = 'Lista Note';
Sbi.locale.ln['sbi.execution.notes.insertNotes'] = 'Inserisci le note';
Sbi.locale.ln['sbi.execution.notes.savenotes'] = 'Salva';
Sbi.locale.ln['sbi.execution.notes.detailNote'] = 'Dettaglio';
Sbi.locale.ln['sbi.execution.notes.deleteNote'] = 'Cancella';
Sbi.locale.ln['sbi.execution.notes.owner'] = 'Proprietario';
Sbi.locale.ln['sbi.execution.notes.creationDate'] = 'Data creazione';
...
Sbi.locale.ln['sbi.worksheet.export.previewtab.msg'] = 'Per esportare il documento worksheet \u00e8 necesario andare in preview';
...
Sbi.locale.ln['sbi.ds.test'] = 'Anteprima';
Sbi.locale.ln['sbi.ds.datasetTestPanel.title'] = 'Vedi anteprima';
...
Sbi.locale.ln['sbi.ds.noQbeDesigner']= 'Qbe designer non abilitato per dataset parametrici!';
Sbi.locale.ln['sbi.ds.file.type'] = 'Tipo';
Sbi.locale.ln['sbi.ds.file.upload.button'] = 'Carica il file';
Sbi.locale.ln['sbi.ds.file.csv.delimiter'] = 'Carattere delimitazione';
Sbi.locale.ln['sbi.ds.file.csv.quote'] = 'Carattere <br /> quote';
Sbi.locale.ln['sbi.ds.file.xsl.sheetnumber'] = 'Numero <br />Foglio';
Sbi.locale.ln['sbi.ds.file.xsl.limitrows'] = 'Numero limite righe';
Sbi.locale.ln['sbi.ds.file.xsl.skiprows'] = 'Salta <br /> righe';
...
Sbi.locale.ln['sbi.ds.EXISTS']= 'Il file � gi� presente nel server';
...
Sbi.locale.ln['sbi.ds.metadata.msgKO']='La validazione ha riscontrato alcuni errori. Le celle contenenti errori sono colorate in rosso. Muovendo il mouse su tali celle comparir� un tooltip contenente maggiori informazioni relative all\'errore occorso';
...
Sbi.locale.ln['sbi.scheduler.overview'] = 'Panoramica Attivit� ';
...
Sbi.locale.ln['sbi.scheduler.activity.detailactivity'] = 'Dettaglio Attivit�';
Sbi.locale.ln['sbi.scheduler.activity.schedulationlist'] = 'Lista Schedulazioni';
Sbi.locale.ln['sbi.scheduler.activity.deleted'] = 'Attivit� Eliminata';
...
Sbi.locale.ln['sbi.tools.managedatasets.errors.missingdatamart'] = 'Seleziona un datamart';
Sbi.locale.ln['sbi.tools.managedatasets.errors.missingdatasource'] = 'Seleziona un datasource';

//===================================================================
//DATASET - PREVIEW
//===================================================================
Sbi.locale.ln['sbi.tools.dataset.previewwindow.title'] = 'Anteprima';

//===================================================================
//DATASTORE PANEL
//===================================================================
Sbi.locale.ln['sbi.widgets.datastorepanel.title'] = 'Risultati';

Sbi.locale.ln['sbi.widgets.datastorepanel.grid.displaymsg'] = 'Visualizza {0} - {1} of {2}';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.emptymsg'] = 'Nessun risultato';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.emptywarningmsg'] = 'La query non ha restituito valori';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.beforeoverflow'] = 'Soglia massima del numero di record';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.afteroverflow'] = 'superata';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.beforepagetext'] = 'Pagina';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.afterpagetext'] = 'di {0}';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.firsttext'] = 'Prima Pagina';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.prevtext'] = 'Pagina precedente';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.nexttext'] = 'Pagina successiva';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.lasttext'] = 'Pagina successiva';
Sbi.locale.ln['sbi.widgets.datastorepanel.grid.refreshtext'] = 'Aggiorna';

Sbi.locale.ln['sbi.widgets.datastorepanel.button.tt.exportto'] = 'Esporta a';

//===================================================================
//DOMAIN 
//===================================================================
Sbi.locale.ln['sbi.domain.managedomains.fields.valuecd'] = 'Codice valore';
Sbi.locale.ln['sbi.domain.managedomains.fields.valuenm'] = 'Nome valore';
Sbi.locale.ln['sbi.domain.managedomains.fields.valueds'] = 'Descrizione valore';
...
Sbi.locale.ln['sbi.browser.mexport.massiveExportWizard.button.cancel'] = 'Annulla';
...
Sbi.locale.ln['sbi.browser.mexport.massiveExportWizardParametersPage.title'] = 'Parametri';
...
Sbi.locale.ln["sbi.community.functCode"]="Funzionalit�";
...
//Multitenant
Sbi.locale.ln['sbi.multitenant.saved']= 'Tenant salvato correttamente. \n L\'utente amministratore del tenant � stato creato con username e password ';
...
//===================================================================
Sbi.locale.ln['sbi.execution.savedocumentwindow.saved']= 'Il documento � stato salvato correttamente; � disponibile nella sezione "Le mie analisi"';
//===================================================================
//Hierarchies Editor
//===================================================================
Sbi.locale.ln['sbi.hierarchies.dimensions']= 'Dimensioni';			
Sbi.locale.ln['sbi.hierarchies.hierarchies']= 'Gerarchie';
Sbi.locale.ln['sbi.hierarchies.date']= 'Situazione alla data';	
Sbi.locale.ln['sbi.hierarchies.refresh']= 'Aggiorna';	
...
Sbi.locale.ln['sbi.hierarchies.custom.for']= 'Gerarchie Custom per: ';
Sbi.locale.ln['sbi.hierarchies.node.deleted']= 'Nodo cancellato';	
Sbi.locale.ln['sbi.hierarchies.node.delete']= 'Cancella nodo';		
Sbi.locale.ln['sbi.hierarchies.type.semimanual']= 'Semi-Manuale';		
Sbi.locale.ln['sbi.hierarchies.type.manual']= 'Manuale';	
Sbi.locale.ln['sbi.hierarchies.new.type']= 'Tipo nuova gerarchia';		
Sbi.locale.ln['sbi.hierarchies.new.create']= 'Crea nuova gerarchia';		
Sbi.locale.ln['sbi.hierarchies.new.create.wrong']= 'Impostare i parametri necessari per costruire la gerarchia';	
Sbi.locale.ln['sbi.hierarchies.save.changes']= 'Salva modifiche';
Sbi.locale.ln['sbi.hierarchies.show.tree']= 'Visualizza albero gerarchia';
Sbi.locale.ln['sbi.hierarchies.custom.delete']= 'Elimina gerarchia custom';		
...
Sbi.locale.ln['sbi.hierarchies.save.wrong']= 'Prima di procedere al salvamento � necessario definire la nuova gerarchia!';
Sbi.locale.ln['sbi.hierarchies.scope']= 'Visibilit� Gerarchia';		
...
Sbi.locale.ln['sbi.hierarchies.drag.wrong']= 'Non � possibile usare una nodo foglia come nuova radice';		
