...
Sbi.tools.massiveExport.MassiveExportWizardWindow = function(config) {
	...
	if (Sbi.settings && Sbi.settings.tools 
			&& Sbi.settings.tools.massiveExport && Sbi.settings.tools.massiveExport.massiveExportWizardWindow) {
...
Ext.extend(Sbi.tools.massiveExport.MassiveExportWizardWindow, Ext.Window, {
	...
	, initOptionsPage: function() {
		...
		this.optionsPage = new Sbi.tools.massiveExport.MassiveExportOptionsPanel(config);
