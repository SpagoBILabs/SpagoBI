...
//FILTERS PANEL
//===================================================================
Sbi.locale.ln['sbi.formviewer.staticclosedfilterspanel.title'] = 'Est\u00E1ticos filtros cerrados';
Sbi.locale.ln['sbi.formviewer.staticopenfilterspanel.title'] = 'Est\u00E1ticos filtros abiertos';
...
Sbi.locale.ln['sbi.formviewer.dynamicfilterspanel.tovalue'] = 'hasta';
...
Sbi.locale.ln['sbi.formviewer.groupingvariablespanel.variable-2'] = 'Segunda  variable';

//===================================================================
//VALIDATION
//===================================================================
Sbi.locale.ln['sbi.formviewer.formviewerpage.validation.error'] = 'Error';
Sbi.locale.ln['sbi.formviewer.staticopenfilterspanel.validation.maxselectiontext'] = 'Máximo {0} art	u00EDculos permitidos para el filtro "{1}"';
Sbi.locale.ln['sbi.formviewer.dynamicfilter.validation.missingvalue'] = 'Falta el valor de la variable "{0}"';

//===================================================================
//RESULTS PAGE
//===================================================================
Sbi.locale.ln['sbi.formviewer.resultspage.backtoform'] = 'Espalda';