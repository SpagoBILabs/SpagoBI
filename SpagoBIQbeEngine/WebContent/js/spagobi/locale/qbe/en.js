...
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.eq'] = 'true if the field\'s value is equal to filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.noteq'] = 'true if the field\'s value is not equal to filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.gt'] = 'true if the field\'s value is greater than filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.eqgt'] = 'true if the field\'s value is equal or greater than filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.lt'] = 'true if the field\'s value is less than filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.eqlt'] = 'true if the field\'s value starts with filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.starts'] = 'true if the field\'s value is equal or less than filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notstarts'] = 'true if the field\'s value doesn\'t start with filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.ends'] = 'true if the field\'s value ends with filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notends'] = 'true if the field\'s value doesn\'t end with filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.contains'] = 'true if the field\'s value contains filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notcontains'] = 'true if the field\'s value doesn\'t contain filter\'s value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.between'] = 'true if the field\'s value is between the range specified in the filter value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notbetween'] = 'true if the field\'s value is not between the range specified in the filter value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.in'] = 'true if the field\'s value is equal to one of the values specified in the filter value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notin'] = 'true if the field\'s value is not equal to any of the values specified in the filter value';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notnull'] = 'true if the field\'s value is not null';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.isnull'] = 'true if the field\'s value is null';
