...
//QBE PANEL
//===================================================================
Sbi.locale.ln['sbi.qbe.qbepanel.worksheetdesignerpanel.tools.preview'] = 'Pr\u00E9visualiser la feuille de calcul';
...
Sbi.locale.ln['sbi.qbe.savewindow.selectmetadata'] = 'Ins\u00E9rer des m\u00E9tadonn\u00E9es';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.tooltip.lolast'] = 'Derni\u00E8re valeur de l\'op\u00E9rande gauche';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.tooltip.rolast'] = 'Derni\u00E8re valeur de l\'op\u00E9rande droite';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.eqgt'] = 'vrai si la valeur du champ est \u00E9gale ou sup\u00E9rieure \u00E0 la valeur du filtre';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notstarts'] = 'vrai si la valeur du champ commence par la valeur du filtre';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.ends'] = 'vrai si la valeur du champs finit par la valeur du filtre';
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.notends'] = 'vrai si la valeur du champ ne finit pas par la valeur du filtre';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.foperators.desc.between'] = 'vrai si la valeur du champ est comprise dans l\'intervalle sp\u00E9cifi\u00E9 dans le filtre';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.warning.deleteAll.title'] = 'Supprimer tous les filtres ?';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.warning.changebolop.title'] = 'Changer le connecteur bool\u00E9en ?';
Sbi.locale.ln['sbi.qbe.filtergridpanel.warning.changebolop.msg'] = 'Changer le connecteur bool\u00E9en de ce filtre r\u00E9initialise l\'expression associ\u00E9e (voir l\'assistant des expressions). Souhaitez-vous toujours le supprimer ?';
...
Sbi.locale.ln['sbi.qbe.selectgridpanel.aggfunc.desc.labelOpCount'] = 'Attribut \u00E0 utiliser dans la fonction d\u00E9ecompte';
Sbi.locale.ln['sbi.qbe.selectgridpanel.aggfunc.desc.labelOpCountDist'] = 'Attribut \u00E0 utiliser en fonction Count Distinct';
Sbi.locale.ln['sbi.qbe.selectgridpanel.aggfunc.desc.labelOpAVG'] = 'Attribut \u00E0 utiliser en fonction moyenne';
...
Sbi.locale.ln['sbi.qbe.selectgridpanel.func.sum.tip'] = 'Fonction somme binaire';
Sbi.locale.ln['sbi.qbe.selectgridpanel.func.difference.tip'] = 'Fonction diff\u00E9rence binaire';
Sbi.locale.ln['sbi.qbe.selectgridpanel.func.multiplication.tip'] = 'Fonction multiplication binaire';
Sbi.locale.ln['sbi.qbe.selectgridpanel.func.division.tip'] = 'Fonction Division binaire';
Sbi.locale.ln['sbi.qbe.selectgridpanel.func.pipe.tip'] = 'pipe';
Sbi.locale.ln['sbi.qbe.selectgridpanel.func.openpar.tip'] = 'Parenth\u00E8se ouverte';
Sbi.locale.ln['sbi.qbe.selectgridpanel.func.closepar.tip'] = 'Parenth\u00E8se ferm\u00E9e';
...
Sbi.locale.ln['sbi.qbe.selectgridpanel.sortfunc.desc.none'] = 'Aucun ordre appliqu\u00E9 \u00E0 ces colonnes';
...
//buttons 
Sbi.locale.ln['sbi.qbe.selectgridpanel.buttons.text.hide'] = 'Cacher les champs';
Sbi.locale.ln['sbi.qbe.selectgridpanel.buttons.tt.hide'] = 'Cacher tous les champs';
...
Sbi.locale.ln['sbi.qbe.freeconditionswindow.buttons.text.saveasdefaults'] = 'Enregistrer sous par d\u00E9faut';
Sbi.locale.ln['sbi.qbe.freeconditionswindow.buttons.text.restorelast'] = 'Restaurer le dernier';

//===================================================================
//QUERY CATALOGUE PANEL
//===================================================================
Sbi.locale.ln['sbi.qbe.cataloguepanel.title'] = 'Biblioth\u00E8que de requ\u00EAtes';
...
//===================================================================
Sbi.locale.ln['sbi.qbe.documentparametersgridpanel.title'] = 'Param\u00E8tres du document';
...
Sbi.locale.ln['sbi.qbe.datastorepanel.externalservices.errors.title'] = 'Erreur';
...
Sbi.locale.ln['sbi.qbe.calculatedFields.functions.script'] = 'Fonctions script ';
...
Sbi.locale.ln['sbi.qbe.calculatedFields.string.type'] = 'Si l\'expression du script retourne une cha\u00eene de caract\u00e8res bruts';
...
Sbi.locale.ln['sbi.qbe.calculatedFields.add'] = 'Ajouter un champ calcul\u00e9';
Sbi.locale.ln['sbi.qbe.calculatedFields.remove'] = 'Supprimer un champ calcul\u00e9';
Sbi.locale.ln['sbi.qbe.calculatedFields.edit'] = 'Modifier un champ calcul\u00e9';
Sbi.locale.ln['sbi.qbe.calculatedFields.add.error'] = 'Impossible d\'ajouter un champ calcul\u00e9 \u00e0 un noeud de type [{0}]';


//===================================================================
//BANDS WIZARD
//===================================================================
Sbi.locale.ln['sbi.qbe.menu.bands.add'] = 'Ajouter Range';
Sbi.locale.ln['sbi.qbe.menu.bands.edit'] = 'Modifier Range';
Sbi.locale.ln['sbi.qbe.bands.title'] = 'Assistant Range... ';
Sbi.locale.ln['sbi.qbe.bands.noteditable'] = 'Impossible de charger la d\u00E9finition du Range ';
Sbi.locale.ln['sbi.qbe.bands.back.btn'] = 'Retour';
Sbi.locale.ln['sbi.qbe.bands.next.btn'] = 'Suivant';
Sbi.locale.ln['sbi.qbe.bands.finish.btn'] = 'Terminer';
Sbi.locale.ln['sbi.qbe.bands.save.btn'] = 'Enregistrer';
Sbi.locale.ln['sbi.qbe.bands.addband.btn'] = 'Ajouter bande';
Sbi.locale.ln['sbi.qbe.bands.adddefault.btn'] = 'Ajouter d\u00E9faut ';
Sbi.locale.ln['sbi.qbe.bands.delete.btn'] = 'Supprimer';
Sbi.locale.ln['sbi.qbe.bands.col.name'] = 'Nom';
Sbi.locale.ln['sbi.qbe.bands.col.values'] = 'Valeurs';
Sbi.locale.ln['sbi.qbe.bands.col.limits'] = 'Limites';
Sbi.locale.ln['sbi.qbe.bands.col.vallist'] = 'Liste des valeurs';
Sbi.locale.ln['sbi.qbe.bands.alert.default'] = 'Op\u00E9ration refus\u00E9e pour la tranche par d\u00E9faut';
Sbi.locale.ln['sbi.qbe.bands.delete.alert.title'] = 'Suppression tranche';
Sbi.locale.ln['sbi.qbe.bands.delete.alert.msg'] = 'Confirmer \u00E9l\u00E9ment \u00E0 supprimer??';
Sbi.locale.ln['sbi.qbe.bands.new.name'] = 'Nouvelle tranche';
Sbi.locale.ln['sbi.qbe.bands.default.name'] = 'Autres';
Sbi.locale.ln['sbi.qbe.bands.default.alert'] = 'Deafult d\u00E9j\u00E0 d\u00E9fini';
Sbi.locale.ln['sbi.qbe.bands.prefix'] = 'Tranche-';
Sbi.locale.ln['sbi.qbe.bands.wizard.invalid.definition'] = 'D\u00E9finition non valide';
Sbi.locale.ln['sbi.qbe.bands.wizard.invalid.definition.msg'] = 'Impossible d\'ajouter emplacement pour un n\u0153ud de type [{0}] ';
Sbi.locale.ln['sbi.qbe.bands.wizard.invalid.operation'] = 'Op\u00E9ration non valide';
Sbi.locale.ln['sbi.qbe.bands.wizard.invalid.operation.msg'] = 'N\u0153ud de type [{0}] n\'a pas \u00E9t\u00E9 modifi\u00E9  ';
Sbi.locale.ln['sbi.qbe.bands.wizard.invalid.operation.delete.msg'] = 'N\u0153ud de type [{0}] n\'a pas \u00E9t\u00E9 supprim\u00E9';
Sbi.locale.ln['sbi.qbe.bands.wizard.invalid.operation.edit.msg'] = 'N\u0153ud de type [{0}] n\'a pas \u00E9t\u00E9 modifi\u00E9  ';
