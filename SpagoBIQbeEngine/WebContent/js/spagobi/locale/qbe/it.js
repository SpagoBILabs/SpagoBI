...
Sbi.locale.ln['sbi.qbe.qbecardspanel.preview'] = 'Anteprima';
...
Sbi.locale.ln['sbi.qbe.queryeditor.msgwarning'] = 'La query è incorreta; vuoi salvarla lo stesso?';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.headers.isfree.desc'] = 'Il valore del filtro viene richiesto in una popup quando la query viene eseguita';
...
Sbi.locale.ln['sbi.qbe.filtergridpanel.headers.boperator.desc'] = 'Connettore logico tra filtri';
...
Sbi.locale.ln['sbi.qbe.parametersgridpanel.parameterreference'] = 'Parametro';
...
Sbi.locale.ln['sbi.qbe.calculatedFields.functions.arithmentic'] = 'Funzioni aritmetiche';
Sbi.locale.ln['sbi.qbe.calculatedFields.functions.script'] = 'Funzioni groovy';
...
Sbi.locale.ln['sbi.qbe.calculatedFields.operands.title.text'] = 'Seleziona Operando';
...
Sbi.locale.ln['sbi.qbe.relationshipswizard.roles.entity.alias.title']='Aliases per l\'entit\u00e0 ';
Sbi.locale.ln['sbi.qbe.relationshipswizard.roles.entity.alias.field.column']='Mapping campo/alias entit\u00e0';
Sbi.locale.ln['sbi.qbe.relationshipswizard.roles.field.title']='Campi della query';
Sbi.locale.ln['sbi.qbe.relationshipswizard.roles.field.column']='Campi';

//===================================================================
//SAVE DATASET WIZARD
//===================================================================
Sbi.locale.ln['sbi.qbe.savedatasetwindow.title'] = 'Isenrisci i dettagli del dataset e clicca sul pulsante Salva';