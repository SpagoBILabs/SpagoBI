...
Sbi.worksheet.runtime.RuntimeSheetsContainerPanel = function(config) { 
	...
	var sheetConf = {title:'ssddsd', footer:'asdasdsad'};
	var cc = {sheetConf : sheetConf};
	this.on('render', function(){this.add(new Sbi.worksheet.runtime.RuntimeSheetPanel(cc));}, this);
};
