...
public class CrosstabXLSXExporter {
	...
	/** Logger component. */
    public static transient Logger logger = Logger.getLogger(CrosstabXLSXExporter.class);
	...
	public int commonFillSheet(Sheet sheet,JSONObject json, CreationHelper createHelper, int startRow) throws SerializationException, JSONException{	
		...
		buildColumnsHeader(sheet, columnsRootChilds, startRow, rowsDepth , createHelper);
