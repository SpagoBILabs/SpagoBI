...
public class CrossTab {
	 ...
	 */
	public CrossTab(IDataStore dataStore, CrosstabDefinition crosstabDefinition, WorksheetEngineInstance worksheetEngineInstance, JSONArray calculateFields)
	 ...
	 * @return
	 */
	private static String executeOperationOnNumbers(List<String> data, List<String> op) {
		String operation = "";
		int i = 0;
	...
	private void addMeasuresScaleFactor(WorksheetEngineInstance engineInstance) {
