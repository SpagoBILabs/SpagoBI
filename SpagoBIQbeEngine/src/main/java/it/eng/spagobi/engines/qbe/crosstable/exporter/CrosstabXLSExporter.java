...
public class CrosstabXLSExporter {
	...
	public int fillAlreadyCreatedSheet(Sheet sheet, CrossTab cs, JSONObject crosstabJSON, CreationHelper createHelper, int startRow, Locale locale)
	...
	public int commonFillSheet(Sheet sheet, CrossTab cs, JSONObject crosstabJSON, CreationHelper createHelper, int startRow, Locale locale)
