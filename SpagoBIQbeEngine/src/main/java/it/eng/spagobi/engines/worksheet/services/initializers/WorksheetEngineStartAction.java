...
public class WorksheetEngineStartAction extends AbstractEngineStartAction {
	...
	/*
	 * This is useful when starting a worksheet document created starting from a non-persisted dataset and using also QBE. In this case the starting dataset
	...
	public void initDataSource(WorksheetEngineInstance worksheetEngineInstance) {
		...
		if (qbeEngineInstance != null) {
			...
			datasource = ((AbstractDataSource) qbeEngineInstance.getDataSource()).getToolsDataSource();
		} else {
	...
	public void setWorksheetEngineInstance(WorksheetEngineInstance worksheetEngineInstance) {
