...
<body>
<h2>Example 8 : injectWorksheet into non-existing div</h2>
<hr>
<b>Description:</b> Use <i>injectWorksheet</i> function to inject into a div an html string that contains the definition of an iframe 
