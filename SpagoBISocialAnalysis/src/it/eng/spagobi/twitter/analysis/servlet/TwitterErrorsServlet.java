 ...
 *
 */
public class TwitterErrorsServlet extends HttpServlet {

	/**
	 *
	 */
	private static final long serialVersionUID = -4433038159065011137L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher requetsDispatcherObj = request.getRequestDispatcher("/WEB-INF/jsp/errors/error.jsp");
