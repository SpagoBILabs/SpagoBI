 ...
 *
 */
public class TwitterSummaryTabServlet extends HttpServlet {

	/**
	 *
	 */
	private static final long serialVersionUID = 728089665581671757L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher requetsDispatcherObj = request.getRequestDispatcher("/WEB-INF/jsp/tabs/summary.jsp");
