 ...
 *
 */
public class TwitterTopicsTabServlet extends HttpServlet {

	/**
	 *
	 */
	private static final long serialVersionUID = 3237210710439319798L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher requetsDispatcherObj = request.getRequestDispatcher("/WEB-INF/jsp/tabs/topics.jsp");
