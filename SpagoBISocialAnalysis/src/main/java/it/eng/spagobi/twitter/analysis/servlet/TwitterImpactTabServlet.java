 ...
 *
 */
public class TwitterImpactTabServlet extends HttpServlet {

	/**
	 *
	 */
	private static final long serialVersionUID = 7820847146739443431L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher requetsDispatcherObj = request.getRequestDispatcher("/WEB-INF/jsp/tabs/impact.jsp");
