/**
 * DataSetServiceSoapBindingStub.java
 *
...
public class DataSetServiceSoapBindingStub extends org.apache.axis.client.Stub implements it.eng.spagobi.services.dataset.stub.DataSetService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://bo.dataset.services.spagobi.eng.it", "SpagoBiDataSet"));
        oper.setReturnClass(it.eng.spagobi.services.dataset.bo.SpagoBiDataSet.class);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getDataSetByLabel");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://bo.dataset.services.spagobi.eng.it", "SpagoBiDataSet"));
        oper.setReturnClass(it.eng.spagobi.services.dataset.bo.SpagoBiDataSet.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getDataSetByLabelReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getAllDataSet");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:spagobidataset", "ArrayOf_tns2_SpagoBiDataSet"));
        oper.setReturnClass(it.eng.spagobi.services.dataset.bo.SpagoBiDataSet[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getAllDataSetReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;
    ...
    public DataSetServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public DataSetServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public DataSetServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://bo.dataset.services.spagobi.eng.it", "SpagoBiDataSet");
            cachedSerQNames.add(qName);
            cls = it.eng.spagobi.services.dataset.bo.SpagoBiDataSet.class;
            ...
            qName = new javax.xml.namespace.QName("urn:spagobidataset", "ArrayOf_tns2_SpagoBiDataSet");
            cachedSerQNames.add(qName);
            cls = it.eng.spagobi.services.dataset.bo.SpagoBiDataSet[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://bo.dataset.services.spagobi.eng.it", "SpagoBiDataSet");
    ...
    public it.eng.spagobi.services.dataset.bo.SpagoBiDataSet getDataSet(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobidataset", "getDataSet"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (it.eng.spagobi.services.dataset.bo.SpagoBiDataSet) _resp;
            } catch (java.lang.Exception _exception) {
                return (it.eng.spagobi.services.dataset.bo.SpagoBiDataSet) org.apache.axis.utils.JavaUtils.convert(_resp, it.eng.spagobi.services.dataset.bo.SpagoBiDataSet.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public it.eng.spagobi.services.dataset.bo.SpagoBiDataSet getDataSetByLabel(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobidataset", "getDataSetByLabel"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2});
  ...
  throw axisFaultException;
    ...
    public it.eng.spagobi.services.dataset.bo.SpagoBiDataSet[] getAllDataSet(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobidataset", "getAllDataSet"));
