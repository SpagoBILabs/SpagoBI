/**
 * SbiDocumentServiceSoapBindingStub.java
 *
...
public class SbiDocumentServiceSoapBindingStub extends org.apache.axis.client.Stub implements it.eng.spagobi.services.sbidocument.stub.SbiDocumentService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("getDocumentAnalyticalDrivers");
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:spagobisbidocument", "ArrayOf_tns2_SpagobiAnalyticalDriver"));
        oper.setReturnClass(it.eng.spagobi.services.sbidocument.bo.SpagobiAnalyticalDriver[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getDocumentAnalyticalDriversReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getDocumentAnalyticalDriversJSON");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "getDocumentAnalyticalDriversJSONReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
    ...
    public SbiDocumentServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public SbiDocumentServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public SbiDocumentServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://bo.sbidocument.services.spagobi.eng.it", "SpagobiAnalyticalDriver");
            cachedSerQNames.add(qName);
            cls = it.eng.spagobi.services.sbidocument.bo.SpagobiAnalyticalDriver.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:spagobisbidocument", "ArrayOf_tns2_SpagobiAnalyticalDriver");
            cachedSerQNames.add(qName);
            cls = it.eng.spagobi.services.sbidocument.bo.SpagobiAnalyticalDriver[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://bo.sbidocument.services.spagobi.eng.it", "SpagobiAnalyticalDriver");
            ...
            qName = new javax.xml.namespace.QName("urn:spagobisbidocument", "ArrayOf_xsd_anyType");
            cachedSerQNames.add(qName);
    ...
    public it.eng.spagobi.services.sbidocument.bo.SpagobiAnalyticalDriver[] getDocumentAnalyticalDrivers(java.lang.String in0, java.lang.String in1, java.lang.Integer in2, java.lang.String in3, java.lang.String in4) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobisbidocument", "getDocumentAnalyticalDrivers"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2, in3, in4});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (it.eng.spagobi.services.sbidocument.bo.SpagobiAnalyticalDriver[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (it.eng.spagobi.services.sbidocument.bo.SpagobiAnalyticalDriver[]) org.apache.axis.utils.JavaUtils.convert(_resp, it.eng.spagobi.services.sbidocument.bo.SpagobiAnalyticalDriver[].class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public java.lang.String getDocumentAnalyticalDriversJSON(java.lang.String in0, java.lang.String in1, java.lang.Integer in2, java.lang.String in3, java.lang.String in4) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobisbidocument", "getDocumentAnalyticalDriversJSON"));
