...
public class SecurityServiceSoapBindingStub extends org.apache.axis.client.Stub implements it.eng.spagobi.services.security.stub.SecurityService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("checkAuthorization");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        oper.setReturnClass(boolean.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "checkAuthorizationReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;
    ...
    public SecurityServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://bo.security.services.spagobi.eng.it", "SpagoBIUserProfile");
            cachedSerQNames.add(qName);
            cls = it.eng.spagobi.services.security.bo.SpagoBIUserProfile.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:spagobisecurity", "ArrayOf_soapenc_string");
            cachedSerQNames.add(qName);
    ...
    public it.eng.spagobi.services.security.bo.SpagoBIUserProfile getUserProfile(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobisecurity", "getUserProfile"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (it.eng.spagobi.services.security.bo.SpagoBIUserProfile) _resp;
            } catch (java.lang.Exception _exception) {
                return (it.eng.spagobi.services.security.bo.SpagoBIUserProfile) org.apache.axis.utils.JavaUtils.convert(_resp, it.eng.spagobi.services.security.bo.SpagoBIUserProfile.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public boolean isAuthorized(java.lang.String in0, java.lang.String in1, java.lang.String in2, java.lang.String in3) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobisecurity", "isAuthorized"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2, in3});
  ...
  throw axisFaultException;
    ...
    public boolean checkAuthorization(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobisecurity", "checkAuthorization"));
