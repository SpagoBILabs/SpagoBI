 ...
 *
 */
public class CopyOfJDBCDataProxy extends AbstractDataProxy {

	IDataSource dataSource;
	String statement;
	String schema=null;

	private static transient Logger logger = Logger.getLogger(CopyOfJDBCDataProxy.class);


	public CopyOfJDBCDataProxy() {
	...
	public CopyOfJDBCDataProxy(IDataSource dataSource, String statement) {
		setDataSource(dataSource);
		setStatement(statement);
	}

	public CopyOfJDBCDataProxy(IDataSource dataSource) {
		setDataSource(dataSource);
		setStatement(statement);
	}
