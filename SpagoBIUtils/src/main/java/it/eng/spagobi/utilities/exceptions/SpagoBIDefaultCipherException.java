...
public class SpagoBIDefaultCipherException extends RuntimeException {
	...
	/**
	 * Builds a <code>SpagoBIDefaultCipherException</code>.
	 * 
	 * @param message Text of the exception
	 */
    public SpagoBIDefaultCipherException(String message) {
    	super(message);
    }
     ...
     */
    public SpagoBIDefaultCipherException(String message, Throwable ex) {
    	super(message, ex);
    }
     ...
     * @param ex previous Throwable object
     */
    public SpagoBIDefaultCipherException(Throwable ex) {
    	super(ex);
    }
