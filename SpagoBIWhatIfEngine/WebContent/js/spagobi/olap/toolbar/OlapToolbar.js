...
Ext.define('Sbi.olap.toolbar.OlapToolbar', {
	...
	config:{
		...
		whatIfButtons: [ 'BUTTON_SAVE','BUTTON_SAVE_NEW', 'BUTTON_UNDO','BUTTON_VERSION_MANAGER','BUTTON_EXPORT_OUTPUT','BUTTON_CALCULATED_MEMBERS','BUTTON_EXPORT_XLS','BUTTON_ALGORITHMS'],//,'BUTTON_ALGORITHMS'],
		...
		olapButtons: ['BUTTON_MDX','BUTTON_FLUSH_CACHE','BUTTON_EXPORT_XLS'],
