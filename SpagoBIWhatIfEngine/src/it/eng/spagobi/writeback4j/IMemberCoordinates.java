 ...
 *
 * @class IMemberCordinates
 * The coordinates of a Member.. For coordinates we means the column and the table with the leafs for the member..  
 */
public interface IMemberCoordinates {
	...
	/**
	 * Gets the name of the foreign key of the cube that links the fact table and the dimension that contains the cube
	 * @return
	 */
	public String getForeignKey();
	
	/**
	 * Gets the inner joins.. If the hierarchy is the Join of more than one table, returns the join condition between tables  
	 * @return
	 */
