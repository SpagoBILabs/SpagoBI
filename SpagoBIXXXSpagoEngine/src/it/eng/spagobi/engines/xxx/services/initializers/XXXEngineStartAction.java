 ...
 * 
 **/
package it.eng.spagobi.engines.xxx.services.initializers;

import it.eng.spago.base.SourceBean;
import it.eng.spagobi.engines.xxx.XXXEngine;
 ...
 * Entry point action.
 */
public class XXXEngineStartAction extends AbstractEngineStartAction {
	...
	/** Logger component. */
    public static transient Logger logger = Logger.getLogger(XXXEngineStartAction.class);
    
    private static final String ENGINE_NAME = "SpagoBIConsoleEngine";
    private static final String REQUEST_DISPATCHER_URL = "/WEB-INF/jsp/XXX.jsp";
	

	public void service(SourceBean serviceRequest, SourceBean serviceResponse)  {
		logger.debug("IN");		
		Locale locale;
		XXXEngineInstance consoleEngineInstance = null;
		...
		try {
			...
			try {
				consoleEngineInstance = XXXEngine.createInstance( getTemplateAsString(), getEnv() );
			} catch(Throwable t) {
