 ...
 */
public class XXXEngineException extends SpagoBIEngineException {
	...
	*/
	 ...
	 */
    public XXXEngineException(String message) {
    	super(message);
    }
     ...
     */
    public XXXEngineException(String message, Throwable ex) {
    	super(message, ex);
    }
