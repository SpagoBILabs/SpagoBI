...
*
* @version $Id: XDimension.java,v 1.4 2009/12/17 16:14:29 PhilippBouillon Exp $
*
*/
...
/**
 * <code>XDimension</code>
 * TODO DOCUMENT ME
 *
 * @version $Id: XDimension.java,v 1.4 2009/12/17 16:14:29 PhilippBouillon Exp $
 **/
public class XDimension extends XPaloObject {
	...
	public XDimension(String id, String name, XDatabase database) {
		setId(id);
		setName(name);
