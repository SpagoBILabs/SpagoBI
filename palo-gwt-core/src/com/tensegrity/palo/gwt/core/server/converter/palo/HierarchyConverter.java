...
*
* @version $Id: HierarchyConverter.java,v 1.3 2009/12/17 16:14:29 PhilippBouillon Exp $
*
*/
...
/**
 * <code>HierarchyConverter</code>
 * TODO DOCUMENT ME
 *
 * @version $Id: HierarchyConverter.java,v 1.3 2009/12/17 16:14:29 PhilippBouillon Exp $
 **/
public class HierarchyConverter extends BaseConverter {
	...
	public XObject toXObject(Object nativeObj) {
		Hierarchy hierarchy = (Hierarchy) nativeObj;
		XDimension xDimension = 
			(XDimension) XConverter.createX(hierarchy.getDimension());
		XHierarchy xHierarchy = 
			new XHierarchy(hierarchy.getId(), hierarchy.getName(), xDimension);
		return xHierarchy;
	}
}
