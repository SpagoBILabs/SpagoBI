...
* @author ArndHouben
*
* @version $Id: FormatRangeHandler.java,v 1.2 2009/12/17 16:14:29 PhilippBouillon Exp $
*
*/
 ...
 * @version $Id: FormatRangeHandler.java,v 1.2 2009/12/17 16:14:29 PhilippBouillon Exp $
 **/
abstract class FormatRangeHandler {
	...
	protected final HashSet <FormatRangeInfo> ranges;
	protected FormatRangeInfo currRange = null;
	
	FormatRangeHandler() {
		ranges = new HashSet <FormatRangeInfo> ();
		registerHandlers();
	}
