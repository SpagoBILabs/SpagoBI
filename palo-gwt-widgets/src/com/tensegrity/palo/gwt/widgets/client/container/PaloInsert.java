...
*
* @version $Id: PaloInsert.java,v 1.7 2010/03/11 10:42:18 PhilippBouillon Exp $
*
*/
...
public class PaloInsert extends BoxComponent {

	  private int height = -1;
	  
	  public PaloInsert(int height) {
	    setShadow(false);
	    this.height = height;
	  ...
	  protected void onRender(Element target, int index) {
	    ...
	    sb.append("<img src=\"images/insert-bg.gif\"/>");
