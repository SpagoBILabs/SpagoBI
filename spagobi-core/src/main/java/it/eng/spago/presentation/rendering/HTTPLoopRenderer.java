...
public class HTTPLoopRenderer extends AbstractServletModelRenderer implements RenderIFace {
	 ...
	 * (non-Javadoc)
	 *
	 * @see it.eng.spago.view.AbstractServletModelRenderer#prepareRender(it.eng.spago.dispatching.service.RequestContextIFace,
	 * it.eng.spago.presentation.PublisherConfiguration, java.lang.Object)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see it.eng.spago.view.AbstractServletModelRenderer#render(it.eng.spago.dispatching.service.RequestContextIFace,
	 * it.eng.spago.presentation.PublisherConfiguration, java.lang.Object)
	 */
	@Override
	public void render(RequestContextIFace requestContext, PublisherConfiguration publisher, Object additionalResources) throws Exception {
		RequestContainer requestContainer = requestContext.getRequestContainer();
		...
		if (publisher.getResources().size() != 0) {
			TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.WARNING, "LoopRenderer::render: Resource list not empty");
		}
	...
	static {
		...
		try {
			...
			TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.CRITICAL, "LoopRenderer::static initializer:", sbe);
		}
	}
