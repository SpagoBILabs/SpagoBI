...
public class DocumentParameters {
	...
	public DocumentParameters(BIObjectParameter biParam, String exeRole, Locale loc, BIObject obj,HttpServletRequest req) {
	...
	public void loadValues(HttpServletRequest req) {
	...
	public void loadDefaultValues(HttpServletRequest req) {
		logger.debug("IN");
		try {
	...
	private List getLOV(HttpServletRequest req) {
		List rows = null;
