...
public class DefaultValuesRetriever {
	...
	public AnalyticalDriverValueList getDefaultValues(
		...
		logger.debug("IN");
		AnalyticalDriverValueList defaultValues = null;
		try {
		...
		if (defaultValues == null) {
			defaultValues = new AnalyticalDriverValueList();
		}
		logger.debug("OUT");
		return defaultValues;
	}

	protected AnalyticalDriverValueList getDefaultValuesFromDefaultLov(
			ExecutionInstance executionInstance, IEngUserProfile profile,
			ILovDetail lovForDefault) throws Exception, SourceBeanException {
		logger.debug("IN");
		AnalyticalDriverValueList defaultValues = new AnalyticalDriverValueList();
		...
		while (it.hasNext()) {
			...
			AnalyticalDriverValue defaultValue = new AnalyticalDriverValue();
