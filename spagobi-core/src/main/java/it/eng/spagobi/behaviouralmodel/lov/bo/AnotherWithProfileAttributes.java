...
public class AnotherWithProfileAttributes implements IJavaClassLov {
	...
	public String getValues(IEngUserProfile profile) {
		...
		result += "<ROW VALUE=\"";
		try {
			result += profile.getUserAttribute("age") + "\"/>"; // Different from "WithProfileAttributes.java"
		} catch (EMFInternalError e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public List<String> getNamesOfProfileAttributeRequired() {
		...
		necessaryProfileAttr.add("age"); // Different from "WithProfileAttributes.java"
