...
public class Formula {
	...
	/**
	 * Returns a List with all the available formulas: they are configured in WEB-INF/conf/tools/scheduler/formulas.xml. In case no formulas are found, an empty
