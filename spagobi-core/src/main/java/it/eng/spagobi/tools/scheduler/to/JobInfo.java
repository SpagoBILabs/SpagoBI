...
public class JobInfo implements Serializable {
	...
	private final Map<BIObject, Map<BIObjectParameter, String>> dateRangePeriodByParamByDocument = new HashMap<>();
	...
	public String getDateRangePeriod(BIObject doc, BIObjectParameter key) {
		Map<BIObjectParameter, String> params = dateRangePeriodByParamByDocument.get(doc);
		if (params == null) {
			return null;
		}
	...
	public void putDateRangePeriod(BIObject doc, BIObjectParameter key, String value) {
		Map<BIObjectParameter, String> params = dateRangePeriodByParamByDocument.get(doc);
		if (params == null) {
			params = new HashMap<>();
			dateRangePeriodByParamByDocument.put(doc, params);
		}
